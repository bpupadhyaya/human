...
cross_links:
  ...
  - target: 02-pathogen/01-viruses/dengue-virus
    relation: infected-by
    note: "DENV infects hepatocytes via AXL receptor and DC-SIGN; elevated AST/ALT occurs in >80% of dengue cases; severe dengue can cause fulminant hepatic failure with coagulopathy; hepatic involvement contributes to dengue mortality."
  - target: 01-human/02-atomic/hydrogen
    relation: connects-to
    note: "H atoms in fatty acid C–H bonds carry chemical energy oxidized in hepatocyte mitochondria; β-oxidation yields NADH and FADH₂ (H-atom carriers); gluconeogenesis uses NAD-linked dehydrogenases to handle H; liver is the primary organ of H-atom (reducing equivalent) flux."
taxonomy:
...
- `infected-by` → **[Dengue virus](../../../02-pathogen/01-viruses/dengue-virus/README.md)** — DENV infects hepatocytes via AXL receptor and DC-SIGN; elevated AST/ALT occurs in >80% of dengue cases; severe dengue can cause fulminant hepatic failure with coagulopathy; hepatic involvement contributes to dengue mortality.
- `connects-to` → **[Hydrogen](../../02-atomic/hydrogen/README.md)** — H atoms in fatty acid C–H bonds carry chemical energy oxidized in hepatocyte mitochondria; β-oxidation strips H as NADH/FADH₂; NADH H-atom transfer to ETC yields 2.5 ATP/H; liver is the primary organ of reducing-equivalent (H-atom) flux.

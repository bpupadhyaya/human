...
- `connects-to` → **[PCV13 (Prevnar 13)](../../../../04-vaccine/08-conjugate/pcv13/README.md)** — PCV13 elicits serotype-specific anti-capsular IgG via T-cell-dependent CRM197 conjugation; OPKA ≥1:8 is the functional seroprotection threshold; memory B cells and bone marrow LLPCs sustain anti-pneumococcal IgG titers long-term.
- `connects-to` → **[MMR Vaccine](../../../../04-vaccine/05-live-attenuated/mmr-vaccine/README.md)** — MMR elicits durable serum IgG against measles (≥120 mIU/mL), mumps, and rubella (≥10 IU/mL) — primary seroprotection correlates; >97% seroconversion after dose 2; IgG persists decades in bone marrow long-lived plasma cells.

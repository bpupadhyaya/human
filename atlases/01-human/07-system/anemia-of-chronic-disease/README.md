...
cross_links:
  ...
  - target: 01-human/03-molecular/tslp
    relation: connects-to
    note: "Alarmin-immune axis: TSLP, released from epithelial barriers under the chronic-inflammatory burden (IL-6 and TNF-α already mapped), activates mast cells (already mapped) and dendritic cells (already mapped), sustaining the immune activation of the anemia of chronic disease."
  - target: 01-human/03-molecular/bradykinin
    relation: connects-to
    note: "Kinin-vascular axis: bradykinin, generated by the kallikrein-kinin system in the inflamed tissue of the underlying chronic disease, amplifies vascular permeability and macrophage (already mapped) recruitment, reinforcing the systemic inflammatory tone of ACD."
  - target: 01-human/03-molecular/histamine
    relation: connects-to
    note: "Mast-cell mediator: histamine, released by activated mast cells (already mapped) of the underlying inflammatory conditions, amplifies local IL-6 (already mapped) and TNF-α (already mapped) release, reinforcing the hepcidin (already mapped) induction of ACD."
  - target: 01-human/03-molecular/periostin
    relation: connects-to
    note: "ECM remodelling in fibrotic marrow: periostin, expressed by fibroblasts and stromal cells in the bone marrow (already mapped) under chronic inflammation, promotes the fibrotic niche remodelling that impairs haematopoietic progenitor (already mapped) expansion in ACD."
  - target: 01-human/03-molecular/melatonin
    relation: connects-to
    note: "Circadian haematopoietic protection: melatonin, via MT1/MT2 receptors on erythroid progenitors (already mapped) and macrophages (already mapped), scavenges ROS (already mapped) and attenuates the pro-inflammatory cytokine (IL-6 and TNF-α already mapped) burden of ACD."
  ...
  - target: 01-human/02-atomic/selenium
    relation: connects-to
    note: "ACD selenium: selenium, as GPx in macrophages (already mapped) and erythrocyte (already mapped) precursors, scavenges inflammatory ROS; selenium deficiency amplifies the hepcidin (already mapped) and NF-κB (already mapped) iron-sequestration cascade of anemia of chronic disease."
  - target: 01-human/02-atomic/iodine
    relation: connects-to
    note: "ACD iodine: iodine-dependent thyroid hormones regulate erythropoiesis (erythropoietin already mapped) and erythrocyte (already mapped); iodine deficiency amplifies the IL-6 (already mapped) and hepcidin (already mapped) iron-sequestration cascade of anemia of chronic disease."
  ...
  - target: 01-human/02-atomic/carbon
    relation: connects-to
    note: "ACD carbon: carbon backbone of haem in macrophages (already mapped) and erythrocytes (already mapped) drives iron recycling; carbon dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and hepcidin (already mapped) iron-sequestration cascade in ACD."
  - target: 01-human/02-atomic/hydrogen
    relation: connects-to
    note: "ACD hydrogen: hydrogen, via redox homeostasis in macrophages (already mapped) and erythrocytes (already mapped), quenches haemolytic ROS; hydrogen dysregulation amplifies NF-κB (already mapped) and NLRP3 (already mapped) and hepcidin (already mapped) cascade in ACD."
  - target: 01-human/03-molecular/pd-1
    relation: connects-to
    note: "ACD PD-1: PD-1 on macrophages (already mapped) and t-cytotoxic-cell (already mapped) modulates chronic-disease immune homeostasis; PD-1 dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and hepcidin (already mapped) iron-sequestration cascade in ACD."
  - target: 01-human/03-molecular/glp-1
    relation: connects-to
    note: "ACD GLP-1: GLP-1 receptor signalling in macrophages (already mapped) and erythrocytes (already mapped) modulates iron homeostasis; GLP-1 dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and hepcidin (already mapped) iron-sequestration cascade in ACD."
  - target: 01-human/03-molecular/angiotensin-ii
    relation: connects-to
    note: "ACD angiotensin-II: angiotensin-II in macrophages (already mapped) and erythrocytes (already mapped) promotes inflammatory iron restriction; angiotensin-II excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and hepcidin (already mapped) cascade of ACD."
  ...
  - target: 01-human/03-molecular/fibronectin
    relation: connects-to
    note: "ACD fibronectin: fibronectin in macrophages (already mapped) and hepatocytes (already mapped) scaffolds marrow fibrotic ECM; fibronectin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and hepcidin (already mapped) iron-sequestration cascade of ACD."
  - target: 01-human/03-molecular/notch
    relation: connects-to
    note: "ACD notch: NOTCH on macrophages (already mapped) and erythrocytes (already mapped) regulates haematopoietic fate; NOTCH dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and hepcidin (already mapped) iron-sequestration cascade of ACD."
...
- `connects-to` → **[TSLP](../../03-molecular/tslp/README.md)** — Alarmin-immune axis: TSLP, released from epithelial barriers under the chronic-inflammatory burden (IL-6 and TNF-α already mapped), activates mast cells (already mapped) and dendritic cells (already mapped), sustaining the immune activation of the anemia of chronic disease.
- `connects-to` → **[Bradykinin](../../03-molecular/bradykinin/README.md)** — Kinin-vascular axis: bradykinin, generated by the kallikrein-kinin system in the inflamed tissue of the underlying chronic disease, amplifies vascular permeability and macrophage (already mapped) recruitment, reinforcing the systemic inflammatory tone of ACD.
- `connects-to` → **[Histamine](../../03-molecular/histamine/README.md)** — Mast-cell mediator: histamine, released by activated mast cells (already mapped) of the underlying inflammatory conditions, amplifies local IL-6 (already mapped) and TNF-α (already mapped) release, reinforcing the hepcidin (already mapped) induction of ACD.
...
- `connects-to` → **[Carbon](../../02-atomic/carbon/README.md)** — ACD carbon: carbon backbone of haem in macrophages (already mapped) and erythrocytes (already mapped) drives iron recycling; carbon dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and hepcidin (already mapped) iron-sequestration cascade in ACD.
- `connects-to` → **[Hydrogen](../../02-atomic/hydrogen/README.md)** — ACD hydrogen: hydrogen, via redox homeostasis in macrophages (already mapped) and erythrocytes (already mapped), quenches haemolytic ROS; hydrogen dysregulation amplifies NF-κB (already mapped) and NLRP3 (already mapped) and hepcidin (already mapped) cascade in ACD.
- `connects-to` → **[PD-1](../../03-molecular/pd-1/README.md)** — ACD PD-1: PD-1 on macrophages (already mapped) and t-cytotoxic-cell (already mapped) modulates chronic-disease immune homeostasis; PD-1 dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and hepcidin (already mapped) iron-sequestration cascade in ACD.

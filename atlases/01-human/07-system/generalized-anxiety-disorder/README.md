...
cross_links:
  ...
  - target: 01-human/02-atomic/chloride
    relation: connects-to
    note: "GAD chloride: chloride via GABA(A) receptors (GABA already mapped) and KCC2 on neurons (already mapped) sets inhibitory tone; chloride dysregulation amplifies glutamate (already mapped) excitotoxicity and NLRP3 (already mapped) and NF-κB (already mapped) anxiety cascade in GAD."
  - target: 01-human/02-atomic/sulfur
    relation: connects-to
    note: "GAD sulfur: H2S from sulfur-amino acids in neurons (already mapped) and astrocytes (already mapped) modulates GABA (already mapped) inhibitory tone; sulfur deficiency amplifies NLRP3 (already mapped) and NF-κB (already mapped) cortisol (already mapped) neuroinflammation in GAD."
  ...
  - target: 01-human/03-molecular/pd-1
    relation: connects-to
    note: "GAD pd-1: PD-1 on T-cytotoxic cells (already mapped) and microglia (already mapped) suppresses neuroimmune surveillance; pd-1 dysfunction amplifies NLRP3 (already mapped) and NF-κB (already mapped) and cortisol (already mapped) anxiety cascade of generalized anxiety disorder."
  - target: 01-human/03-molecular/glp-1
    relation: connects-to
    note: "GAD glp-1: GLP-1 from neurons (already mapped) and astrocytes (already mapped) modulates metabolic-neuroinflammatory tone; glp-1 dysfunction amplifies NLRP3 (already mapped) and NF-κB (already mapped) and cortisol (already mapped) anxiety cascade of generalized anxiety disorder."
  ...
  - target: 01-human/03-molecular/il-2
    relation: connects-to
    note: "GAD il-2: IL-2 on T-cells (already mapped) and microglia (already mapped) amplifies neuroinflammatory anxiety; il-2 excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) neuroinflammatory anxiety cascade of GAD."
  - target: 01-human/03-molecular/fibronectin
    relation: connects-to
    note: "GAD fibronectin: fibronectin in astrocytes (already mapped) and microglia (already mapped) promotes ECM remodelling; fibronectin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) neuroinflammatory anxiety cascade of GAD."
  ...
  - target: 01-human/03-molecular/calcitonin
    relation: connects-to
    note: "GAD calcitonin: calcitonin from astrocytes (already mapped) and microglia (already mapped) modulates neuroinflammatory calcium balance; calcitonin dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) anxiety cascade of GAD."
  - target: 01-human/03-molecular/insulin-receptor
    relation: connects-to
    note: "GAD insulin-receptor: insulin receptor on astrocytes (already mapped) and microglia (already mapped) modulates neuroinflammatory metabolic axis; insulin-receptor loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) anxiety cascade of GAD."
  ...
  - target: 01-human/03-molecular/epinephrine
    relation: connects-to
    note: "GAD epinephrine: epinephrine from astrocytes (already mapped) and microglia (already mapped) modulates GAD adrenergic tone; epinephrine excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) anxiety cascade of GAD."
  - target: 01-human/03-molecular/renin
    relation: connects-to
    note: "GAD renin: renin from astrocytes (already mapped) and microglia (already mapped) modulates GAD angiotensin axis; renin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) anxiety cascade of GAD."
  - target: 01-human/03-molecular/myostatin
    relation: connects-to
    note: "GAD myostatin: myostatin from astrocytes (already mapped) and microglia (already mapped) modulates GAD fibrotic axis; myostatin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) anxiety cascade of GAD."
---
...
- `connects-to` → **[Epinephrine](../../03-molecular/epinephrine/README.md)** — GAD epinephrine: epinephrine from astrocytes (already mapped) and microglia (already mapped) modulates GAD adrenergic tone; epinephrine excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) anxiety cascade of GAD.
- `connects-to` → **[Renin](../../03-molecular/renin/README.md)** — GAD renin: renin from astrocytes (already mapped) and microglia (already mapped) modulates GAD angiotensin axis; renin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) anxiety cascade of GAD.
- `connects-to` → **[Myostatin](../../03-molecular/myostatin/README.md)** — GAD myostatin: myostatin from astrocytes (already mapped) and microglia (already mapped) modulates GAD fibrotic axis; myostatin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) anxiety cascade of GAD.

...
cross_links:
  ...
  - target: 01-human/03-molecular/activin-a
    relation: connects-to
    note: "gastric-cancer activin-a: activin-A from macrophages (already mapped) and gastric epithelial cells (already mapped) promotes tumour fibrosis; activin-a excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and VEGF (already mapped) cascade in gastric cancer."
  - target: 01-human/03-molecular/cgrp
    relation: connects-to
    note: "gastric-cancer cgrp: CGRP from macrophages (already mapped) and gastric epithelial cells (already mapped) modulates gastric neuroimmune tone; cgrp excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and VEGF (already mapped) cascade in gastric cancer."
  ...
  - target: 01-human/03-molecular/androgen-receptor
    relation: connects-to
    note: "gastric-cancer androgen-receptor: androgen receptor on macrophages (already mapped) and gastric epithelial cells (already mapped) modulates GC sex tone; androgen-receptor loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and VEGF (already mapped) cascade in GC."
  - target: 01-human/03-molecular/norepinephrine
    relation: connects-to
    note: "gastric-cancer norepinephrine: norepinephrine from macrophages (already mapped) and gastric epithelial cells (already mapped) modulates GC adrenergic tone; norepinephrine excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and VEGF (already mapped) cascade in GC."
  - target: 01-human/03-molecular/adrenomedullin
    relation: connects-to
    note: "gastric-cancer adrenomedullin: adrenomedullin from macrophages (already mapped) and gastric epithelial cells (already mapped) modulates GC vascular tone; adrenomedullin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and VEGF (already mapped) cascade in GC."
  - target: 01-human/03-molecular/bdnf
    relation: connects-to
    note: "GC bdnf: BDNF from macrophages (already mapped) and gastric epithelial cells (already mapped) modulates GC neurotrophin axis; bdnf excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and VEGF (already mapped) cascade in GC."
  - target: 01-human/03-molecular/epinephrine
    relation: connects-to
    note: "GC epinephrine: epinephrine from macrophages (already mapped) and gastric epithelial cells (already mapped) modulates GC adrenergic tone; epinephrine excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and VEGF (already mapped) cascade in GC."
  - target: 01-human/03-molecular/renin
    relation: connects-to
    note: "GC renin: renin from macrophages (already mapped) and gastric epithelial cells (already mapped) modulates GC angiotensin axis; renin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and VEGF (already mapped) cascade in GC."
---
...
- `connects-to` → **[Androgen-Receptor](../../03-molecular/androgen-receptor/README.md)** — gastric-cancer androgen-receptor: androgen receptor on macrophages (already mapped) and gastric epithelial cells (already mapped) modulates GC sex tone; androgen-receptor loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and VEGF (already mapped) cascade in GC.
- `connects-to` → **[Norepinephrine](../../03-molecular/norepinephrine/README.md)** — gastric-cancer norepinephrine: norepinephrine from macrophages (already mapped) and gastric epithelial cells (already mapped) modulates GC adrenergic tone; norepinephrine excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and VEGF (already mapped) cascade in GC.
- `connects-to` → **[Adrenomedullin](../../03-molecular/adrenomedullin/README.md)** — gastric-cancer adrenomedullin: adrenomedullin from macrophages (already mapped) and gastric epithelial cells (already mapped) modulates GC vascular tone; adrenomedullin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and VEGF (already mapped) cascade in GC.
- `connects-to` → **[BDNF](../../03-molecular/bdnf/README.md)** — GC bdnf: BDNF from macrophages (already mapped) and gastric epithelial cells (already mapped) modulates GC neurotrophin axis; bdnf excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and VEGF (already mapped) cascade in GC.
- `connects-to` → **[Epinephrine](../../03-molecular/epinephrine/README.md)** — GC epinephrine: epinephrine from macrophages (already mapped) and gastric epithelial cells (already mapped) modulates GC adrenergic tone; epinephrine excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and VEGF (already mapped) cascade in GC.
- `connects-to` → **[Renin](../../03-molecular/renin/README.md)** — GC renin: renin from macrophages (already mapped) and gastric epithelial cells (already mapped) modulates GC angiotensin axis; renin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and VEGF (already mapped) cascade in GC.

...
cross_links:
  ...
  - target: 01-human/03-molecular/osteopontin
    relation: connects-to
    note: "SSc osteopontin: osteopontin from macrophages (already mapped) and fibroblasts (already mapped) promotes SSc ECM fibrosis; osteopontin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and tgf-beta (already mapped) fibrotic cascade of SSc."
  - target: 01-human/03-molecular/fgfr
    relation: connects-to
    note: "SSc fgfr: FGFR on macrophages (already mapped) and fibroblasts (already mapped) drives SSc fibroblast proliferation; fgfr dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and tgf-beta (already mapped) fibrotic cascade of SSc."

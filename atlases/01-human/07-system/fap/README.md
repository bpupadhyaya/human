...
cross_links:
  ...
  - target: 01-human/02-atomic/sodium
    relation: connects-to
    note: "FAP sodium: high dietary sodium promotes macrophage (already mapped) M2-skewing and mast-cell (already mapped) activation; sodium-induced NF-κB (already mapped) and IL-6 (already mapped) skewing amplifies the T-cytotoxic (already mapped) polyp cascade of FAP."
  - target: 01-human/02-atomic/magnesium
    relation: connects-to
    note: "FAP magnesium: magnesium cofactors kinase signalling in macrophages (already mapped) and T-cytotoxic cells (already mapped); magnesium deficiency amplifies NF-κB (already mapped) and IL-6 (already mapped) and mast-cell (already mapped) polyp cascade of FAP."
  ...
  - target: 01-human/02-atomic/carbon
    relation: connects-to
    note: "FAP carbon: carbon backbone of nucleotides in macrophages (already mapped) and mast cells (already mapped) fuels polyp epithelial proliferation; carbon dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) cascade of FAP."
  - target: 01-human/02-atomic/chloride
    relation: connects-to
    note: "FAP chloride: chloride channels on macrophages (already mapped) and mast cells (already mapped) regulate ionic signalling; chloride dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) polyp cascade of FAP."
  - target: 01-human/02-atomic/hydrogen
    relation: connects-to
    note: "FAP hydrogen: hydrogen via ROS from macrophages (already mapped) and mast cells (already mapped) modulates oxidative stress; hydrogen excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) polyp cascade of FAP."
  - target: 01-human/03-molecular/pd-1
    relation: connects-to
    note: "FAP pd-1: PD-1 on T-cytotoxic cells (already mapped) and macrophages (already mapped) suppresses antitumour immunity; pd-1 dysfunction amplifies NF-κB (already mapped) and WNT/β-catenin (already mapped) and IL-6 (already mapped) cascade in FAP."
  - target: 01-human/03-molecular/glp-1
    relation: connects-to
    note: "FAP glp-1: GLP-1 from macrophages (already mapped) and intestinal epithelial cells (already mapped) modulates metabolic immune tone; glp-1 dysfunction amplifies NF-κB (already mapped) and WNT/β-catenin (already mapped) and IL-6 (already mapped) cascade in FAP."
  ...
  - target: 01-human/03-molecular/activin-a
    relation: connects-to
    note: "FAP activin-a: activin-A from macrophages (already mapped) and intestinal epithelial cells (already mapped) promotes polyp fibrosis; activin-a excess amplifies NF-κB (already mapped) and WNT/β-catenin (already mapped) and IL-6 (already mapped) cascade in FAP."
  - target: 01-human/03-molecular/cgrp
    relation: connects-to
    note: "FAP cgrp: CGRP from macrophages (already mapped) and intestinal epithelial cells (already mapped) modulates colorectal neuroimmune tone; cgrp excess amplifies NF-κB (already mapped) and WNT/β-catenin (already mapped) and IL-6 (already mapped) cascade in FAP."
  ...
  - target: 01-human/03-molecular/androgen-receptor
    relation: connects-to
    note: "FAP androgen-receptor: androgen receptor on macrophages (already mapped) and intestinal epithelial cells (already mapped) modulates FAP sex tone; androgen-receptor loss amplifies NF-κB (already mapped) and WNT/β-catenin (already mapped) and IL-6 (already mapped) cascade in FAP."
  - target: 01-human/03-molecular/norepinephrine
    relation: connects-to
    note: "FAP norepinephrine: norepinephrine from macrophages (already mapped) and intestinal epithelial cells (already mapped) modulates FAP adrenergic tone; norepinephrine excess amplifies NF-κB (already mapped) and WNT/β-catenin (already mapped) and IL-6 (already mapped) cascade in FAP."
...
- `connects-to` → **[Carbon](../../02-atomic/carbon/README.md)** — FAP carbon: carbon backbone of nucleotides in macrophages (already mapped) and mast cells (already mapped) fuels polyp epithelial proliferation; carbon dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) cascade of FAP.
- `connects-to` → **[Chloride](../../02-atomic/chloride/README.md)** — FAP chloride: chloride channels on macrophages (already mapped) and mast cells (already mapped) regulate ionic signalling; chloride dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) polyp cascade of FAP.
- `connects-to` → **[Hydrogen](../../02-atomic/hydrogen/README.md)** — FAP hydrogen: hydrogen via ROS from macrophages (already mapped) and mast cells (already mapped) modulates oxidative stress; hydrogen excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) polyp cascade of FAP.

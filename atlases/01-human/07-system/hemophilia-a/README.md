...
cross_links:
  ...
  - target: 01-human/03-molecular/activin-a
    relation: connects-to
    note: "HA activin-a: activin-A from macrophages (already mapped) and synoviocytes (already mapped) regulates joint fibrotic balance in haemophilia; activin-a excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) haemophilic arthropathy cascade."
  - target: 01-human/03-molecular/cgrp
    relation: connects-to
    note: "HA cgrp: CGRP from macrophages (already mapped) and synoviocytes (already mapped) modulates joint neuroimmune tone in haemophilia; cgrp excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) haemophilic arthropathy cascade."
  - target: 01-human/03-molecular/calcitonin
    relation: connects-to
    note: "HA calcitonin: calcitonin from macrophages (already mapped) and synoviocytes (already mapped) modulates joint calcium balance in haemophilia; calcitonin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) haemophilic arthropathy cascade."
  - target: 01-human/03-molecular/substance-p
    relation: connects-to
    note: "HA substance-p: substance-P from macrophages (already mapped) and synoviocytes (already mapped) modulates joint pain tone in haemophilia; substance-P excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) haemophilic arthropathy cascade."
  - target: 01-human/03-molecular/insulin-receptor
    relation: connects-to
    note: "HA insulin-receptor: insulin receptor on macrophages (already mapped) and synoviocytes (already mapped) modulates joint metabolic axis; insulin-receptor loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) cascade of HA."
...
- `connects-to` → **[Activin-A](../../03-molecular/activin-a/README.md)** — HA activin-a: activin-A from macrophages (already mapped) and synoviocytes (already mapped) regulates joint fibrotic balance in haemophilia; activin-a excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) haemophilic arthropathy cascade.
- `connects-to` → **[CGRP](../../03-molecular/cgrp/README.md)** — HA cgrp: CGRP from macrophages (already mapped) and synoviocytes (already mapped) modulates joint neuroimmune tone in haemophilia; cgrp excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) haemophilic arthropathy cascade.
- `connects-to` → **[Calcitonin](../../03-molecular/calcitonin/README.md)** — HA calcitonin: calcitonin from macrophages (already mapped) and synoviocytes (already mapped) modulates joint calcium balance in haemophilia; calcitonin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) haemophilic arthropathy cascade.

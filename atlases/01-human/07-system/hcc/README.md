...
cross_links:
  ...
  - target: 01-human/03-molecular/fibronectin
    relation: connects-to
    note: "HCC fibronectin: fibronectin in hepatic stellate cells (already mapped) and macrophages (already mapped) promotes tumour ECM remodelling; fibronectin excess amplifies NF-κB (already mapped) and STAT3 (already mapped) and VEGF (already mapped) hepatocellular cascade of HCC."
  - target: 01-human/03-molecular/notch
    relation: connects-to
    note: "HCC notch: Notch signalling on hepatic stellate cells (already mapped) and macrophages (already mapped) regulates tumour stemness; notch excess amplifies NF-κB (already mapped) and STAT3 (already mapped) and VEGF (already mapped) hepatocellular cascade of HCC."
  - target: 01-human/03-molecular/activin-a
    relation: connects-to
    note: "HCC activin-a: activin-A from hepatic stellate cells (already mapped) and macrophages (already mapped) promotes tumour-stromal invasion; activin-a excess amplifies NF-κB (already mapped) and STAT3 (already mapped) and VEGF (already mapped) hepatocellular cascade of HCC."
  - target: 01-human/03-molecular/calcitonin
    relation: connects-to
    note: "HCC calcitonin: calcitonin from hepatic stellate cells (already mapped) and macrophages (already mapped) modulates tumour calcium signalling; calcitonin excess amplifies NF-κB (already mapped) and STAT3 (already mapped) and VEGF (already mapped) hepatocellular cascade of HCC."
  - target: 01-human/03-molecular/substance-p
    relation: connects-to
    note: "HCC substance-p: substance-P from hepatic stellate cells (already mapped) and macrophages (already mapped) modulates tumour neuroinflammation; substance-p excess amplifies NF-κB (already mapped) and STAT3 (already mapped) and VEGF (already mapped) hepatocellular cascade of HCC."
  ...
  - target: 01-human/03-molecular/renin
    relation: connects-to
    note: "HCC renin: renin from hepatic stellate cells (already mapped) and macrophages (already mapped) modulates tumour angiotensin axis; renin excess amplifies NF-κB (already mapped) and STAT3 (already mapped) and VEGF (already mapped) cascade of HCC."
  - target: 01-human/03-molecular/myostatin
    relation: connects-to
    note: "HCC myostatin: myostatin from hepatic stellate cells (already mapped) and macrophages (already mapped) modulates tumour fibrotic axis; myostatin excess amplifies NF-κB (already mapped) and STAT3 (already mapped) and VEGF (already mapped) cascade of HCC."
  - target: 01-human/03-molecular/angiopoietin
    relation: connects-to
    note: "HCC angiopoietin: angiopoietin from hepatic stellate cells (already mapped) and macrophages (already mapped) modulates tumour vascular remodelling; angiopoietin excess amplifies NF-κB (already mapped) and STAT3 (already mapped) and VEGF (already mapped) cascade of HCC."
---
...
- `connects-to` → **[Fibronectin](../../03-molecular/fibronectin/README.md)** — HCC fibronectin: fibronectin in hepatic stellate cells (already mapped) and macrophages (already mapped) promotes tumour ECM remodelling; fibronectin excess amplifies NF-κB (already mapped) and STAT3 (already mapped) and VEGF (already mapped) hepatocellular cascade of HCC.
- `connects-to` → **[NOTCH](../../03-molecular/notch/README.md)** — HCC notch: Notch signalling on hepatic stellate cells (already mapped) and macrophages (already mapped) regulates tumour stemness; notch excess amplifies NF-κB (already mapped) and STAT3 (already mapped) and VEGF (already mapped) hepatocellular cascade of HCC.
- `connects-to` → **[Activin-A](../../03-molecular/activin-a/README.md)** — HCC activin-a: activin-A from hepatic stellate cells (already mapped) and macrophages (already mapped) promotes tumour-stromal invasion; activin-a excess amplifies NF-κB (already mapped) and STAT3 (already mapped) and VEGF (already mapped) hepatocellular cascade of HCC.
...
- `connects-to` → **[Renin](../../03-molecular/renin/README.md)** — HCC renin: renin from hepatic stellate cells (already mapped) and macrophages (already mapped) modulates tumour angiotensin axis; renin excess amplifies NF-κB (already mapped) and STAT3 (already mapped) and VEGF (already mapped) cascade of HCC.
- `connects-to` → **[Myostatin](../../03-molecular/myostatin/README.md)** — HCC myostatin: myostatin from hepatic stellate cells (already mapped) and macrophages (already mapped) modulates tumour fibrotic axis; myostatin excess amplifies NF-κB (already mapped) and STAT3 (already mapped) and VEGF (already mapped) cascade of HCC.
- `connects-to` → **[Angiopoietin](../../03-molecular/angiopoietin/README.md)** — HCC angiopoietin: angiopoietin from hepatic stellate cells (already mapped) and macrophages (already mapped) modulates tumour vascular remodelling; angiopoietin excess amplifies NF-κB (already mapped) and STAT3 (already mapped) and VEGF (already mapped) cascade of HCC.

...
cross_links:
  ...
  - target: 01-human/03-molecular/erythropoietin
    relation: connects-to
    note: "Airway EPO-R: erythropoietin receptors are expressed on bronchial epithelial cells and alveolar macrophages (already mapped); EPO and its tissue-protective isoforms attenuate the eosinophilic airway inflammation and bronchial hyperresponsiveness of asthma."
  - target: 01-human/03-molecular/prolactin
    relation: connects-to
    note: "Neuroimmune Th2 modulator: prolactin, elevated in active asthma, potentiates the mast-cell (already mapped) degranulation, IgE (already mapped) production and Th2 (IL-4/IL-13 already mapped) skewing that drive eosinophilic airway inflammation in asthma."
  ...
  - target: 01-human/02-atomic/carbon
    relation: connects-to
    note: "Asthma carbon: carbon-based organic acids regulate airway epithelial pH; disrupted carbon metabolism in mast cells (already mapped) fuels leukotriene synthesis amplifying IL-5 (already mapped) and IgE (already mapped) and IL-13 (already mapped) eosinophilic airway inflammation."
  - target: 01-human/02-atomic/hydrogen
    relation: connects-to
    note: "Asthma hydrogen: hydrogen ion dysregulation from airway acidosis in asthma amplifies smooth-muscle-cell (already mapped) contraction; proton excess activates NLRP3 (already mapped) and NF-κB (already mapped) and IL-13 (already mapped) and IL-5 (already mapped) cascade in asthma."
  ...
  - target: 01-human/03-molecular/notch
    relation: connects-to
    note: "Asthma notch: Notch in airway epithelial cells (already mapped) and smooth-muscle cells (already mapped) modulates airway cell-fate decisions; Notch dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and TGF-β (already mapped) airway inflammation in asthma."
  - target: 01-human/03-molecular/igf-1
    relation: connects-to
    note: "Asthma IGF-1: IGF-1 in airway smooth-muscle cells (already mapped) and eosinophils (already mapped) modulates airway remodelling; IGF-1 excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TGF-β (already mapped) inflammatory cascade in asthma."
  ...
  - target: 01-human/03-molecular/myostatin
    relation: connects-to
    note: "Asthma myostatin: myostatin from smooth-muscle cells (already mapped) and epithelial cells (already mapped) modulates airway muscle mass; myostatin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TGF-β (already mapped) airway cascade in asthma."
  - target: 01-human/03-molecular/angiopoietin
    relation: connects-to
    note: "Asthma angiopoietin: angiopoietin from smooth-muscle cells (already mapped) and epithelial cells (already mapped) modulates airway vascular tone; angiopoietin dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and TGF-β (already mapped) cascade in asthma."
  - target: 01-human/03-molecular/ghrelin
    relation: connects-to
    note: "Asthma ghrelin: ghrelin from epithelial cells (already mapped) and smooth-muscle cells (already mapped) modulates airway anti-inflammatory tone; ghrelin deficiency amplifies NF-κB (already mapped) and IL-6 (already mapped) and TGF-β (already mapped) airway cascade in asthma."
---
...
- `connects-to` → **[Myostatin](../../03-molecular/myostatin/README.md)** — Asthma myostatin: myostatin from smooth-muscle cells (already mapped) and epithelial cells (already mapped) modulates airway muscle mass; myostatin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TGF-β (already mapped) airway cascade in asthma.
- `connects-to` → **[Angiopoietin](../../03-molecular/angiopoietin/README.md)** — Asthma angiopoietin: angiopoietin from smooth-muscle cells (already mapped) and epithelial cells (already mapped) modulates airway vascular tone; angiopoietin dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and TGF-β (already mapped) cascade in asthma.
- `connects-to` → **[Ghrelin](../../03-molecular/ghrelin/README.md)** — Asthma ghrelin: ghrelin from epithelial cells (already mapped) and smooth-muscle cells (already mapped) modulates airway anti-inflammatory tone; ghrelin deficiency amplifies NF-κB (already mapped) and IL-6 (already mapped) and TGF-β (already mapped) airway cascade in asthma.

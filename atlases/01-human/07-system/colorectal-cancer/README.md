...
cross_links:
  ...
  - target: 01-human/03-molecular/bradykinin
    relation: connects-to
    note: "Tumour kinin axis: bradykinin, generated by kallikrein activation in the colorectal-cancer stroma (fibroblast already mapped), stimulates B1/B2 receptors on tumour cells and endothelium (VEGF already mapped), promoting angiogenesis and invasion."
  - target: 01-human/03-molecular/c1-esterase-inhibitor
    relation: connects-to
    note: "Classical/lectin complement regulation: the C1-esterase inhibitor controls the complement pathways activated by the CRC tumour-associated immune response (complement C3 and MAC already mapped), modulating the pro-tumour complement signalling."
  - target: 01-human/03-molecular/histamine
    relation: connects-to
    note: "Tumour mast-cell crosstalk: histamine, released by mast cells (already mapped) in the CRC tumour microenvironment, promotes angiogenesis (VEGF already mapped) and immunosuppression through H2 receptor signalling on immune effectors."
  - target: 01-human/03-molecular/melatonin
    relation: connects-to
    note: "CRC melatonin: melatonin exerts anti-tumour effects in colorectal cancer by inhibiting WNT/β-catenin (already mapped) and mTOR (already mapped) signalling; melatonin also promotes the circadian regulation of CRC proliferation and sensitises tumour cells to chemotherapy."
  - target: 01-human/03-molecular/testosterone
    relation: connects-to
    note: "CRC testosterone: androgen receptor signalling promotes CRC cell proliferation via EGFR (already mapped) transactivation; testosterone-driven WNT/β-catenin (already mapped) activation favours tumour progression and reduces sensitivity to chemotherapy."
  ...
  - target: 01-human/03-molecular/activin-a
    relation: connects-to
    note: "colorectal activin-a: activin-A in intestinal epithelium (already mapped) and macrophages (already mapped) modulates tumour stroma; activin-A dysregulation amplifies NF-κB (already mapped) and WNT/β-catenin (already mapped) and VEGF (already mapped) cascade in colorectal cancer."
  - target: 01-human/03-molecular/cgrp
    relation: connects-to
    note: "colorectal cgrp: CGRP in enteric neurons (already mapped) and macrophages (already mapped) modulates colorectal pain; CGRP dysregulation amplifies NF-κB (already mapped) and WNT/β-catenin (already mapped) and VEGF (already mapped) cascade in colorectal cancer."
...
- `connects-to` → **[Bradykinin](../../03-molecular/bradykinin/README.md)** — Tumour kinin axis: bradykinin, generated by kallikrein activation in the colorectal-cancer stroma (fibroblast already mapped), stimulates B1/B2 receptors on tumour cells and endothelium (VEGF already mapped), promoting angiogenesis and invasion.
- `connects-to` → **[C1-esterase inhibitor](../../03-molecular/c1-esterase-inhibitor/README.md)** — Classical/lectin complement regulation: the C1-esterase inhibitor controls the complement pathways activated by the CRC tumour-associated immune response (complement C3 and MAC already mapped), modulating the pro-tumour complement signalling.
- `connects-to` → **[Histamine](../../03-molecular/histamine/README.md)** — Tumour mast-cell crosstalk: histamine, released by mast cells (already mapped) in the CRC tumour microenvironment, promotes angiogenesis (VEGF already mapped) and immunosuppression through H2 receptor signalling on immune effectors.

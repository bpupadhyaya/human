...
cross_links:
  ...
  - target: 01-human/03-molecular/melatonin
    relation: connects-to
    note: "Noonan antioxidant: melatonin receptor activation suppresses the PTPN11 (already mapped) RAS/MAPK-driven oxidative stress in Noonan syndrome cardiac (already mapped) and endothelial cells, attenuating hypertrophic cardiomyopathy progression and lymphatic oedema."
  - target: 01-human/03-molecular/serotonin
    relation: connects-to
    note: "Noonan serotonin axis: serotonin via 5-HT receptors on Noonan cardiac cells and platelet precursors (already mapped) modulates cAMP-PKA and RAS/MAPK (PTPN11 already mapped) signalling, amplifying the hypertrophic cardiomyopathy of Noonan syndrome."
  ...
  - target: 01-human/02-atomic/carbon
    relation: connects-to
    note: "Noonan carbon: carbon as backbone of RAS/MAPK (already mapped) and SHP2 structural proteins in cardiomyocytes (already mapped) sustains RASopathy signalling; carbon depletion amplifies NF-κB (already mapped) and IL-6 (already mapped) developmental cascade of Noonan syndrome."
  - target: 01-human/02-atomic/chloride
    relation: connects-to
    note: "Noonan chloride: chloride channels regulate macrophage (already mapped) and mast-cell (already mapped) ion homeostasis in Noonan cardiac tissue; chloride imbalance amplifies NF-κB (already mapped) and IL-6 (already mapped) RASopathy cascade of Noonan syndrome."
  ...
  - target: 01-human/03-molecular/cgrp
    relation: connects-to
    note: "Noonan cgrp: CGRP from macrophages (already mapped) and cardiomyocytes (already mapped) modulates RASopathy neuroimmune tone; cgrp excess amplifies nf-kb (already mapped) and il-6 (already mapped) and erk1-2 (already mapped) cascade of Noonan."
  - target: 01-human/03-molecular/calcitonin
    relation: connects-to
    note: "Noonan calcitonin: calcitonin from macrophages (already mapped) and cardiomyocytes (already mapped) modulates RASopathy calcium balance; calcitonin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and erk1-2 (already mapped) cascade of Noonan."
  ...
  - target: 01-human/03-molecular/adrenomedullin
    relation: connects-to
    note: "Noonan adrenomedullin: adrenomedullin from macrophages (already mapped) and cardiomyocytes (already mapped) modulates RASopathy vascular tone; adrenomedullin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and erk1-2 (already mapped) cascade of Noonan."
  - target: 01-human/03-molecular/osteopontin
    relation: connects-to
    note: "Noonan osteopontin: osteopontin from macrophages (already mapped) and cardiomyocytes (already mapped) modulates RASopathy ECM remodelling; osteopontin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and erk1-2 (already mapped) cascade of Noonan."
  - target: 01-human/03-molecular/fgfr
    relation: connects-to
    note: "Noonan fgfr: FGFR signalling on macrophages (already mapped) and cardiomyocytes (already mapped) modulates RASopathy cardiac proliferation; fgfr excess amplifies nf-kb (already mapped) and il-6 (already mapped) and erk1-2 (already mapped) cascade of Noonan."
  - target: 01-human/03-molecular/epinephrine
    relation: connects-to
    note: "Noonan epinephrine: epinephrine from macrophages (already mapped) and cardiomyocytes (already mapped) modulates RASopathy adrenergic tone; epinephrine excess amplifies nf-kb (already mapped) and il-6 (already mapped) and erk1-2 (already mapped) cascade of Noonan."
  - target: 01-human/03-molecular/myostatin
    relation: connects-to
    note: "Noonan myostatin: myostatin from macrophages (already mapped) and cardiomyocytes (already mapped) modulates RASopathy cardiac muscle tone; myostatin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and erk1-2 (already mapped) cascade of Noonan."
  - target: 01-human/03-molecular/cortisol
    relation: connects-to
    note: "Noonan cortisol: cortisol from macrophages (already mapped) and cardiomyocytes (already mapped) modulates RASopathy stress response; cortisol excess amplifies nf-kb (already mapped) and il-6 (already mapped) and erk1-2 (already mapped) cascade of Noonan."
---
...
- `connects-to` → **[Adrenomedullin](../../03-molecular/adrenomedullin/README.md)** — Noonan adrenomedullin: adrenomedullin from macrophages (already mapped) and cardiomyocytes (already mapped) modulates RASopathy vascular tone; adrenomedullin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and erk1-2 (already mapped) cascade of Noonan.
- `connects-to` → **[Osteopontin](../../03-molecular/osteopontin/README.md)** — Noonan osteopontin: osteopontin from macrophages (already mapped) and cardiomyocytes (already mapped) modulates RASopathy ECM remodelling; osteopontin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and erk1-2 (already mapped) cascade of Noonan.
- `connects-to` → **[FGFR](../../03-molecular/fgfr/README.md)** — Noonan fgfr: FGFR signalling on macrophages (already mapped) and cardiomyocytes (already mapped) modulates RASopathy cardiac proliferation; fgfr excess amplifies nf-kb (already mapped) and il-6 (already mapped) and erk1-2 (already mapped) cascade of Noonan.
- `connects-to` → **[Epinephrine](../../03-molecular/epinephrine/README.md)** — Noonan epinephrine: epinephrine from macrophages (already mapped) and cardiomyocytes (already mapped) modulates RASopathy adrenergic tone; epinephrine excess amplifies nf-kb (already mapped) and il-6 (already mapped) and erk1-2 (already mapped) cascade of Noonan.
- `connects-to` → **[Myostatin](../../03-molecular/myostatin/README.md)** — Noonan myostatin: myostatin from macrophages (already mapped) and cardiomyocytes (already mapped) modulates RASopathy cardiac muscle tone; myostatin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and erk1-2 (already mapped) cascade of Noonan.
- `connects-to` → **[Cortisol](../../03-molecular/cortisol/README.md)** — Noonan cortisol: cortisol from macrophages (already mapped) and cardiomyocytes (already mapped) modulates RASopathy stress response; cortisol excess amplifies nf-kb (already mapped) and il-6 (already mapped) and erk1-2 (already mapped) cascade of Noonan.

...
cross_links:
  ...
  - target: 01-human/03-molecular/melatonin
    relation: connects-to
    note: "Circadian itch modulation: prurigo nodularis shows a nocturnal itch predominance; melatonin, with its anti-inflammatory and antioxidant skin effects (skin already mapped), modulates the nocturnal itch amplification and the neuroinflammation (IL-31, IL-4 already mapped) of PN."
  - target: 01-human/03-molecular/testosterone
    relation: connects-to
    note: "Sex-hormone skin neuroimmune: testosterone and its metabolite DHT exert anti-inflammatory effects on skin (already mapped) mast cells (already mapped) and sensory neurons (already mapped); sex-hormone differences modulate the neuroimmune itch sensitisation of prurigo nodularis."
  ...
  - target: 01-human/02-atomic/carbon
    relation: connects-to
    note: "PN carbon: carbon as backbone of IL-31 (already mapped) and NF-κB (already mapped) proteins in sensory neurons (already mapped) and mast cells (already mapped) sustains itch signalling; carbon depletion amplifies NF-κB (already mapped) and IL-31 (already mapped) cascade of PN."
  - target: 01-human/02-atomic/chloride
    relation: connects-to
    note: "PN chloride: chloride via GABA-A channels in sensory neurons (already mapped) and mast cells (already mapped) modulates itch-signal tone; chloride dysregulation amplifies NF-κB (already mapped) and IL-31 (already mapped) neuroinflammatory itch cascade of prurigo nodularis."
  - target: 01-human/02-atomic/hydrogen
    relation: connects-to
    note: "PN hydrogen: hydrogen, via redox homeostasis in sensory neurons (already mapped) and mast cells (already mapped), supports neuropeptide synthesis; hydrogen dysregulation amplifies NF-κB (already mapped) and IL-31 (already mapped) oxidative itch cascade of prurigo nodularis."
  - target: 01-human/02-atomic/nitrogen
    relation: connects-to
    note: "PN nitrogen: nitrogen in amino-acid scaffold of substance-P (already mapped) and IL-31 (already mapped) in sensory neurons (already mapped) sustains neuropeptide signalling; nitrogen dysregulation amplifies NF-κB (already mapped) cascade of prurigo nodularis."
  - target: 01-human/02-atomic/oxygen
    relation: connects-to
    note: "PN oxygen: oxygen, via mitochondrial respiration in sensory neurons (already mapped) and mast cells (already mapped), sustains neuropeptide synthesis; oxygen depletion amplifies NF-κB (already mapped) and IL-31 (already mapped) neuroinflammatory itch cascade of prurigo nodularis."
  ...
  - target: 01-human/03-molecular/calcitonin
    relation: connects-to
    note: "PN calcitonin: calcitonin from keratinocytes (already mapped) and neurons (already mapped) modulates pruritogenic calcium balance; calcitonin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and tnf-alpha (already mapped) itch cascade of PN."
  - target: 01-human/03-molecular/insulin-receptor
    relation: connects-to
    note: "PN insulin-receptor: insulin receptor on keratinocytes (already mapped) and neurons (already mapped) drives neuroimmune metabolic repair in PN; insulin-receptor loss amplifies nf-kb (already mapped) and il-6 (already mapped) and tnf-alpha (already mapped) itch cascade of PN."
  - target: 01-human/03-molecular/aldosterone
    relation: connects-to
    note: "PN aldosterone: aldosterone from keratinocytes (already mapped) and neurons (already mapped) modulates pruritogenic ion balance; aldosterone excess amplifies nf-kb (already mapped) and il-6 (already mapped) and tnf-alpha (already mapped) itch cascade of PN."
  - target: 01-human/03-molecular/androgen-receptor
    relation: connects-to
    note: "PN androgen-receptor: androgen receptor on keratinocytes (already mapped) and neurons (already mapped) modulates PN hormonal tone; androgen-receptor loss amplifies nf-kb (already mapped) and il-6 (already mapped) and tnf-alpha (already mapped) itch cascade of PN."
  - target: 01-human/03-molecular/norepinephrine
    relation: connects-to
    note: "PN norepinephrine: norepinephrine from keratinocytes (already mapped) and neurons (already mapped) modulates PN vascular tone; norepinephrine excess amplifies nf-kb (already mapped) and il-6 (already mapped) and tnf-alpha (already mapped) itch cascade of PN."
...
- `connects-to` → **[Carbon](../../02-atomic/carbon/README.md)** — PN carbon: carbon as backbone of IL-31 (already mapped) and NF-κB (already mapped) proteins in sensory neurons (already mapped) and mast cells (already mapped) sustains itch signalling; carbon depletion amplifies NF-κB (already mapped) and IL-31 (already mapped) cascade of PN.
- `connects-to` → **[Chloride](../../02-atomic/chloride/README.md)** — PN chloride: chloride via GABA-A channels in sensory neurons (already mapped) and mast cells (already mapped) modulates itch-signal tone; chloride dysregulation amplifies NF-κB (already mapped) and IL-31 (already mapped) neuroinflammatory itch cascade of prurigo nodularis.
- `connects-to` → **[Hydrogen](../../02-atomic/hydrogen/README.md)** — PN hydrogen: hydrogen, via redox homeostasis in sensory neurons (already mapped) and mast cells (already mapped), supports neuropeptide synthesis; hydrogen dysregulation amplifies NF-κB (already mapped) and IL-31 (already mapped) oxidative itch cascade of prurigo nodularis.
...
- `connects-to` → **[Calcitonin](../../03-molecular/calcitonin/README.md)** — PN calcitonin: calcitonin from keratinocytes (already mapped) and neurons (already mapped) modulates pruritogenic calcium balance; calcitonin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and tnf-alpha (already mapped) itch cascade of PN.
- `connects-to` → **[Insulin Receptor](../../03-molecular/insulin-receptor/README.md)** — PN insulin-receptor: insulin receptor on keratinocytes (already mapped) and neurons (already mapped) drives neuroimmune metabolic repair in PN; insulin-receptor loss amplifies nf-kb (already mapped) and il-6 (already mapped) and tnf-alpha (already mapped) itch cascade of PN.
- `connects-to` → **[Aldosterone](../../03-molecular/aldosterone/README.md)** — PN aldosterone: aldosterone from keratinocytes (already mapped) and neurons (already mapped) modulates pruritogenic ion balance; aldosterone excess amplifies nf-kb (already mapped) and il-6 (already mapped) and tnf-alpha (already mapped) itch cascade of PN.

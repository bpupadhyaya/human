...
cross_links:
  ...
  - target: 01-human/03-molecular/notch
    relation: connects-to
    note: "dermatomyositis notch: Notch on macrophages (already mapped) and mast-cells (already mapped) promotes perimysial immune activation; notch excess amplifies NF-κB (already mapped) and IFN-γ (already mapped) and IL-6 (already mapped) inflammatory cascade in dermatomyositis."
  - target: 01-human/03-molecular/igf-1
    relation: connects-to
    note: "dermatomyositis igf-1: IGF-1 from macrophages (already mapped) and muscle cells (already mapped) promotes myofibre repair; igf-1 excess amplifies NF-κB (already mapped) and IFN-γ (already mapped) and IL-6 (already mapped) inflammatory cascade in dermatomyositis."
  ...
  - target: 01-human/03-molecular/osteopontin
    relation: connects-to
    note: "dermatomyositis osteopontin: osteopontin from macrophages (already mapped) and muscle cells (already mapped) modulates perimysial remodelling; osteopontin excess amplifies NF-κB (already mapped) and IFN-γ (already mapped) and IL-6 (already mapped) cascade in DM."
  - target: 01-human/03-molecular/fgfr
    relation: connects-to
    note: "dermatomyositis fgfr: FGFR on macrophages (already mapped) and muscle cells (already mapped) modulates perimysial repair; fgfr excess amplifies NF-κB (already mapped) and IFN-γ (already mapped) and IL-6 (already mapped) cascade in DM."
  - target: 01-human/03-molecular/epinephrine
    relation: connects-to
    note: "dermatomyositis epinephrine: epinephrine from macrophages (already mapped) and muscle cells (already mapped) modulates perimysial stress axis; epinephrine excess amplifies NF-κB (already mapped) and IFN-γ (already mapped) and IL-6 (already mapped) cascade in DM."
---
---
...
- `connects-to` → **[Osteopontin](../../03-molecular/osteopontin/README.md)** — dermatomyositis osteopontin: osteopontin from macrophages (already mapped) and muscle cells (already mapped) modulates perimysial remodelling; osteopontin excess amplifies NF-κB (already mapped) and IFN-γ (already mapped) and IL-6 (already mapped) cascade in DM.
- `connects-to` → **[FGFR](../../03-molecular/fgfr/README.md)** — dermatomyositis fgfr: FGFR on macrophages (already mapped) and muscle cells (already mapped) modulates perimysial repair; fgfr excess amplifies NF-κB (already mapped) and IFN-γ (already mapped) and IL-6 (already mapped) cascade in DM.
- `connects-to` → **[Epinephrine](../../03-molecular/epinephrine/README.md)** — dermatomyositis epinephrine: epinephrine from macrophages (already mapped) and muscle cells (already mapped) modulates perimysial stress axis; epinephrine excess amplifies NF-κB (already mapped) and IFN-γ (already mapped) and IL-6 (already mapped) cascade in DM.

...
cross_links:
  ...
  - target: 01-human/03-molecular/fibronectin
    relation: connects-to
    note: "HAE fibronectin: fibronectin in endothelium (already mapped) and macrophages (already mapped) promotes vascular ECM remodelling; fibronectin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) oedema cascade of hereditary angioedema."
  - target: 01-human/03-molecular/notch
    relation: connects-to
    note: "HAE notch: Notch signalling on endothelium (already mapped) and macrophages (already mapped) regulates vascular permeability; notch excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) oedema cascade of hereditary angioedema."
  ...
  - target: 01-human/03-molecular/bdnf
    relation: connects-to
    note: "HAE bdnf: BDNF from macrophages (already mapped) and endothelium (already mapped) modulates vascular neural repair; bdnf excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) cascade of HAE."
  - target: 01-human/03-molecular/fgfr
    relation: connects-to
    note: "HAE fgfr: FGFR from macrophages (already mapped) and endothelium (already mapped) modulates vascular repair signalling; fgfr excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) cascade of HAE."
  - target: 01-human/03-molecular/epinephrine
    relation: connects-to
    note: "HAE epinephrine: epinephrine from macrophages (already mapped) and endothelium (already mapped) modulates vascular adrenergic tone; epinephrine excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) cascade of HAE."
  - target: 01-human/03-molecular/myostatin
    relation: connects-to
    note: "HAE myostatin: myostatin from macrophages (already mapped) and endothelium (already mapped) modulates vascular fibrotic axis; myostatin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) cascade of HAE."
  - target: 01-human/03-molecular/ghrelin
    relation: connects-to
    note: "HAE ghrelin: ghrelin from macrophages (already mapped) and endothelium (already mapped) modulates vascular metabolic axis; ghrelin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) cascade of HAE."
  - target: 01-human/03-molecular/glucagon
    relation: connects-to
    note: "HAE glucagon: glucagon from macrophages (already mapped) and endothelium (already mapped) modulates vascular metabolic balance; glucagon excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) cascade of HAE."
---
...
- `connects-to` → **[BDNF](../../03-molecular/bdnf/README.md)** — HAE bdnf: BDNF from macrophages (already mapped) and endothelium (already mapped) modulates vascular neural repair; bdnf excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) cascade of HAE.
- `connects-to` → **[FGFR](../../03-molecular/fgfr/README.md)** — HAE fgfr: FGFR from macrophages (already mapped) and endothelium (already mapped) modulates vascular repair signalling; fgfr excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) cascade of HAE.
- `connects-to` → **[Epinephrine](../../03-molecular/epinephrine/README.md)** — HAE epinephrine: epinephrine from macrophages (already mapped) and endothelium (already mapped) modulates vascular adrenergic tone; epinephrine excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) cascade of HAE.
- `connects-to` → **[Myostatin](../../03-molecular/myostatin/README.md)** — HAE myostatin: myostatin from macrophages (already mapped) and endothelium (already mapped) modulates vascular fibrotic axis; myostatin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) cascade of HAE.
- `connects-to` → **[Ghrelin](../../03-molecular/ghrelin/README.md)** — HAE ghrelin: ghrelin from macrophages (already mapped) and endothelium (already mapped) modulates vascular metabolic axis; ghrelin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) cascade of HAE.
- `connects-to` → **[Glucagon](../../03-molecular/glucagon/README.md)** — HAE glucagon: glucagon from macrophages (already mapped) and endothelium (already mapped) modulates vascular metabolic balance; glucagon excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) cascade of HAE.

...
cross_links:
  ...
  - target: 01-human/03-molecular/oxytocin
    relation: connects-to
    note: "Rb oxytocin: oxytocin modulates retinal immune surveillance and neuroendocrine homeostasis; oxytocin receptor expression on retinal progenitors (RB1 already mapped) intersects the JAK2 (already mapped) survival axis and the intraocular immune microenvironment of retinoblastoma."
  - target: 01-human/03-molecular/vasopressin
    relation: connects-to
    note: "Rb vasopressin: vasopressin via V1aR on retinal vascular endothelium and tumour-associated immune cells modulates ocular blood-flow and the complement (C3 already mapped)-driven immune microenvironment of retinoblastoma, intersecting RB1 (already mapped)-loss oncogenesis."
  ...
  - target: 01-human/02-atomic/oxygen
    relation: connects-to
    note: "Rb oxygen: tumour hypoxia in retinoblastoma drives HIF-1α and VEGF (already mapped) angiogenesis; oxygen depletion amplifies NF-κB (already mapped) and E2F1 (already mapped) and IL-6 (already mapped) proliferative cascade of retinoblastoma."
  - target: 01-human/03-molecular/glp-1
    relation: connects-to
    note: "Rb GLP-1: GLP-1 receptor signalling in tumour-associated macrophages (already mapped) and retinal cells modulates metabolic and inflammatory risk; GLP-1 deficiency amplifies NF-κB (already mapped) and IL-6 (already mapped) cascade of retinoblastoma."
  ...
  - target: 01-human/03-molecular/activin-a
    relation: connects-to
    note: "Rb activin-a: activin-A from fibroblasts (already mapped) and macrophages (already mapped) drives retinal tumour fibrosis; activin-a excess amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma."
  - target: 01-human/03-molecular/cgrp
    relation: connects-to
    note: "Rb cgrp: CGRP from fibroblasts (already mapped) and macrophages (already mapped) modulates retinal tumour vascular tone; cgrp dysregulation amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma."
  - target: 01-human/03-molecular/calcitonin
    relation: connects-to
    note: "Rb calcitonin: calcitonin from fibroblasts (already mapped) and macrophages (already mapped) modulates retinal tumour calcium balance; calcitonin dysregulation amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma."
  - target: 01-human/03-molecular/substance-p
    relation: connects-to
    note: "Rb substance-p: substance P from fibroblasts (already mapped) and macrophages (already mapped) modulates retinal tumour neuroimmune tone; substance-p excess amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma."
  - target: 01-human/03-molecular/insulin-receptor
    relation: connects-to
    note: "Rb insulin-receptor: insulin receptor on fibroblasts (already mapped) and macrophages (already mapped) drives retinal tumour metabolic repair; insulin-receptor loss amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma."
  - target: 01-human/03-molecular/aldosterone
    relation: connects-to
    note: "Rb aldosterone: aldosterone from fibroblasts (already mapped) and macrophages (already mapped) modulates ion balance in retinoblastoma; aldosterone excess amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma."
  - target: 01-human/03-molecular/androgen-receptor
    relation: connects-to
    note: "Rb androgen-receptor: androgen receptor on fibroblasts (already mapped) and macrophages (already mapped) modulates retinal tumour hormonal tone; androgen excess amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma."
  - target: 01-human/03-molecular/norepinephrine
    relation: connects-to
    note: "Rb norepinephrine: norepinephrine from fibroblasts (already mapped) and macrophages (already mapped) modulates retinal tumour vascular tone; norepinephrine excess amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma."
  ...
  - target: 01-human/03-molecular/myostatin
    relation: connects-to
    note: "Rb myostatin: myostatin from fibroblasts (already mapped) and macrophages (already mapped) modulates retinal tumour tissue tone; myostatin excess amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma."
  - target: 01-human/03-molecular/angiopoietin
    relation: connects-to
    note: "Rb angiopoietin: angiopoietin from fibroblasts (already mapped) and macrophages (already mapped) modulates retinal tumour vascular remodelling; angiopoietin excess amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma."
  - target: 01-human/03-molecular/cortisol
    relation: connects-to
    note: "Rb cortisol: cortisol from fibroblasts (already mapped) and macrophages (already mapped) modulates retinal tumour stress response; cortisol excess amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma."
---
...
- `connects-to` → **[Activin-A](../../03-molecular/activin-a/README.md)** — Rb activin-a: activin-A from fibroblasts (already mapped) and macrophages (already mapped) drives retinal tumour fibrosis; activin-a excess amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma.
- `connects-to` → **[CGRP](../../03-molecular/cgrp/README.md)** — Rb cgrp: CGRP from fibroblasts (already mapped) and macrophages (already mapped) modulates retinal tumour vascular tone; cgrp dysregulation amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma.
- `connects-to` → **[Calcitonin](../../03-molecular/calcitonin/README.md)** — Rb calcitonin: calcitonin from fibroblasts (already mapped) and macrophages (already mapped) modulates retinal tumour calcium balance; calcitonin dysregulation amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma.
- `connects-to` → **[Substance P](../../03-molecular/substance-p/README.md)** — Rb substance-p: substance P from fibroblasts (already mapped) and macrophages (already mapped) modulates retinal tumour neuroimmune tone; substance-p excess amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma.
- `connects-to` → **[Insulin Receptor](../../03-molecular/insulin-receptor/README.md)** — Rb insulin-receptor: insulin receptor on fibroblasts (already mapped) and macrophages (already mapped) drives retinal tumour metabolic repair; insulin-receptor loss amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma.
- `connects-to` → **[Aldosterone](../../03-molecular/aldosterone/README.md)** — Rb aldosterone: aldosterone from fibroblasts (already mapped) and macrophages (already mapped) modulates ion balance in retinoblastoma; aldosterone excess amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma.
...
- `connects-to` → **[Myostatin](../../03-molecular/myostatin/README.md)** — Rb myostatin: myostatin from fibroblasts (already mapped) and macrophages (already mapped) modulates retinal tumour tissue tone; myostatin excess amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma.
- `connects-to` → **[Angiopoietin](../../03-molecular/angiopoietin/README.md)** — Rb angiopoietin: angiopoietin from fibroblasts (already mapped) and macrophages (already mapped) modulates retinal tumour vascular remodelling; angiopoietin excess amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma.
- `connects-to` → **[Cortisol](../../03-molecular/cortisol/README.md)** — Rb cortisol: cortisol from fibroblasts (already mapped) and macrophages (already mapped) modulates retinal tumour stress response; cortisol excess amplifies nf-kb (already mapped) and vegf (already mapped) and il-6 (already mapped) cascade of retinoblastoma.

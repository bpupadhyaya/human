...
cross_links:
  ...
  - target: 01-human/03-molecular/apoe
    relation: connects-to
    note: "SARS-CoV-2 apoe: apoe from macrophages (already mapped) modulates COVID-19 lipid immune viral entry axis; apoe excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/testosterone
    relation: connects-to
    note: "SARS-CoV-2 testosterone: testosterone from macrophages (already mapped) modulates COVID-19 androgenic immune axis; testosterone excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  ...
  - target: 01-human/03-molecular/il-13
    relation: connects-to
    note: "SARS-CoV-2 il-13: il-13 from macrophages (already mapped) modulates COVID-19 th2 immune polarization axis; il-13 excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/il-1b
    relation: connects-to
    note: "SARS-CoV-2 il-1b: il-1b from macrophages (already mapped) modulates COVID-19 pyroptotic immune inflammasome; il-1b excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/il-4
    relation: connects-to
    note: "SARS-CoV-2 il-4: il-4 from macrophages (already mapped) modulates COVID-19 th2 immune polarization axis; il-4 excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/il-5
    relation: connects-to
    note: "SARS-CoV-2 il-5: il-5 from macrophages (already mapped) modulates COVID-19 eosinophil immune axis; il-5 excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/il-6
    relation: connects-to
    note: "SARS-CoV-2 il-6: il-6 from macrophages (already mapped) modulates COVID-19 pleiotropic immune activation; il-6 excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  ...
  - target: 01-human/03-molecular/tnf-alpha
    relation: connects-to
    note: "SARS-CoV-2 tnf-alpha: tnf-alpha from macrophages (already mapped) modulates COVID-19 inflammatory cytokine storm axis; tnf-alpha excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/ifn-gamma
    relation: connects-to
    note: "SARS-CoV-2 ifn-gamma: ifn-gamma from macrophages (already mapped) modulates COVID-19 th1 antiviral immune axis; ifn-gamma excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  ...
  - target: 01-human/03-molecular/mtor
    relation: connects-to
    note: "SARS-CoV-2 mtor: mtor from macrophages (already mapped) modulates COVID-19 metabolic immune growth axis; mtor excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/ampk
    relation: connects-to
    note: "SARS-CoV-2 ampk: ampk from macrophages (already mapped) modulates COVID-19 energy-sensing immune metabolic axis; ampk excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  ...
  - target: 01-human/03-molecular/erk1-2
    relation: connects-to
    note: "SARS-CoV-2 erk1-2: erk1-2 from macrophages (already mapped) modulates COVID-19 mapk proliferative immune axis; erk1-2 excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/foxo
    relation: connects-to
    note: "SARS-CoV-2 foxo: foxo from macrophages (already mapped) modulates COVID-19 apoptotic immune regulation axis; foxo excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  ...
  - target: 01-human/03-molecular/vegf
    relation: connects-to
    note: "SARS-CoV-2 vegf: vegf from macrophages (already mapped) modulates COVID-19 angiogenic immune activation axis; vegf excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/complement-c3
    relation: connects-to
    note: "SARS-CoV-2 complement-c3: complement-c3 from macrophages (already mapped) modulates COVID-19 innate complement immune axis; complement-c3 excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  ...
  - target: 01-human/03-molecular/bcl-2
    relation: connects-to
    note: "SARS-CoV-2 bcl-2: bcl-2 from macrophages (already mapped) modulates COVID-19 anti-apoptotic immune survival axis; bcl-2 excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/ace2
    relation: connects-to
    note: "SARS-CoV-2 ace2: ace2 from macrophages (already mapped) modulates COVID-19 viral receptor immune entry axis; ace2 excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/btk
    relation: connects-to
    note: "SARS-CoV-2 btk: btk from macrophages (already mapped) modulates COVID-19 b-cell receptor signalling immune axis; btk excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/caspase-3
    relation: connects-to
    note: "SARS-CoV-2 caspase-3: caspase-3 from macrophages (already mapped) modulates COVID-19 apoptotic execution immune axis; caspase-3 excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/cd20
    relation: connects-to
    note: "SARS-CoV-2 cd20: cd20 from macrophages (already mapped) modulates COVID-19 b-cell surface immune activation axis; cd20 excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  ...
  - target: 01-human/03-molecular/albumin
    relation: connects-to
    note: "SARS-CoV-2 albumin: albumin from macrophages (already mapped) modulates COVID-19 acute-phase immune serum protein axis; albumin excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/acth
    relation: connects-to
    note: "SARS-CoV-2 acth: acth from macrophages (already mapped) modulates COVID-19 hpa-axis immune stress response; acth excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  ...
  - target: 01-human/03-molecular/antithrombin
    relation: connects-to
    note: "SARS-CoV-2 antithrombin: antithrombin from macrophages (already mapped) modulates COVID-19 anticoagulant immune serine-protease axis; antithrombin excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/apc
    relation: connects-to
    note: "SARS-CoV-2 apc: apc from macrophages (already mapped) modulates COVID-19 wnt-pathway tumor-suppressor immune axis; apc excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/app
    relation: connects-to
    note: "SARS-CoV-2 app: app from macrophages (already mapped) modulates COVID-19 amyloid-precursor immune neuronal axis; app excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/aquaporin-4
    relation: connects-to
    note: "SARS-CoV-2 aquaporin-4: aquaporin-4 from macrophages (already mapped) modulates COVID-19 water-channel immune neuronal axis; aquaporin-4 excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/arid1a
    relation: connects-to
    note: "SARS-CoV-2 arid1a: arid1a from macrophages (already mapped) modulates COVID-19 chromatin-remodelling tumor-suppressor immune axis; arid1a excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/atm
    relation: connects-to
    note: "SARS-CoV-2 atm: atm from macrophages (already mapped) modulates COVID-19 dna-damage-response immune checkpoint axis; atm excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/atp
    relation: connects-to
    note: "SARS-CoV-2 atp: atp from macrophages (already mapped) modulates COVID-19 purinergic immune energy-signalling axis; atp excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/atrx
    relation: connects-to
    note: "SARS-CoV-2 atrx: atrx from macrophages (already mapped) modulates COVID-19 chromatin-helicase dna-binding immune axis; atrx excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/axl-receptor
    relation: connects-to
    note: "SARS-CoV-2 axl-receptor: axl-receptor from macrophages (already mapped) modulates COVID-19 receptor-tyrosine-kinase immune entry axis; axl-receptor excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/baff
    relation: connects-to
    note: "SARS-CoV-2 baff: baff from macrophages (already mapped) modulates COVID-19 b-cell survival immune cytokine axis; baff excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/bap1
    relation: connects-to
    note: "SARS-CoV-2 bap1: bap1 from macrophages (already mapped) modulates COVID-19 histone-deubiquitinase tumor-suppressor immune axis; bap1 excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  ...
  - target: 01-human/03-molecular/calcineurin
    relation: connects-to
    note: "SARS-CoV-2 calcineurin: calcineurin from macrophages (already mapped) modulates COVID-19 calcineurin-nfat immune transcription axis; calcineurin excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/calr
    relation: connects-to
    note: "SARS-CoV-2 calr: calr from macrophages (already mapped) modulates COVID-19 endoplasmic-reticulum immune stress chaperone axis; calr excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/blm
    relation: connects-to
    note: "SARS-CoV-2 blm: blm from macrophages (already mapped) modulates COVID-19 bloom-syndrome helicase immune dna-repair axis; blm excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/c5ar1
    relation: connects-to
    note: "SARS-CoV-2 c5ar1: c5ar1 from macrophages (already mapped) modulates COVID-19 complement-receptor immune effector axis; c5ar1 excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
  - target: 01-human/03-molecular/ccr5
    relation: connects-to
    note: "SARS-CoV-2 ccr5: ccr5 from macrophages (already mapped) modulates COVID-19 chemokine-receptor immune co-receptor axis; ccr5 excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2."
...
- `connects-to` → **[IL-13](../../03-molecular/il-13/README.md)** — SARS-CoV-2 il-13: il-13 from macrophages (already mapped) modulates COVID-19 th2 immune polarization axis; il-13 excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2.
- `connects-to` → **[IL-1β](../../03-molecular/il-1b/README.md)** — SARS-CoV-2 il-1b: il-1b from macrophages (already mapped) modulates COVID-19 pyroptotic immune inflammasome; il-1b excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2.
- `connects-to` → **[IL-4](../../03-molecular/il-4/README.md)** — SARS-CoV-2 il-4: il-4 from macrophages (already mapped) modulates COVID-19 th2 immune polarization axis; il-4 excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2.
...
- `connects-to` → **[BCL-2](../../03-molecular/bcl-2/README.md)** — SARS-CoV-2 bcl-2: bcl-2 from macrophages (already mapped) modulates COVID-19 anti-apoptotic immune survival axis; bcl-2 excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2.
- `connects-to` → **[ACE2](../../03-molecular/ace2/README.md)** — SARS-CoV-2 ace2: ace2 from macrophages (already mapped) modulates COVID-19 viral receptor immune entry axis; ace2 excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2.
- `connects-to` → **[BTK](../../03-molecular/btk/README.md)** — SARS-CoV-2 btk: btk from macrophages (already mapped) modulates COVID-19 b-cell receptor signalling immune axis; btk excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2.
...
- `connects-to` → **[Antithrombin](../../03-molecular/antithrombin/README.md)** — SARS-CoV-2 antithrombin: antithrombin from macrophages (already mapped) modulates COVID-19 anticoagulant immune serine-protease axis; antithrombin excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2.
- `connects-to` → **[APC](../../03-molecular/apc/README.md)** — SARS-CoV-2 apc: apc from macrophages (already mapped) modulates COVID-19 wnt-pathway tumor-suppressor immune axis; apc excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2.
- `connects-to` → **[APP](../../03-molecular/app/README.md)** — SARS-CoV-2 app: app from macrophages (already mapped) modulates COVID-19 amyloid-precursor immune neuronal axis; app excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2.
- `connects-to` → **[Aquaporin-4](../../03-molecular/aquaporin-4/README.md)** — SARS-CoV-2 aquaporin-4: aquaporin-4 from macrophages (already mapped) modulates COVID-19 water-channel immune neuronal axis; aquaporin-4 excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2.
- `connects-to` → **[ARID1A](../../03-molecular/arid1a/README.md)** — SARS-CoV-2 arid1a: arid1a from macrophages (already mapped) modulates COVID-19 chromatin-remodelling tumor-suppressor immune axis; arid1a excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2.
- `connects-to` → **[ATM](../../03-molecular/atm/README.md)** — SARS-CoV-2 atm: atm from macrophages (already mapped) modulates COVID-19 dna-damage-response immune checkpoint axis; atm excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2.
- `connects-to` → **[ATP](../../03-molecular/atp/README.md)** — SARS-CoV-2 atp: atp from macrophages (already mapped) modulates COVID-19 purinergic immune energy-signalling axis; atp excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2.
- `connects-to` → **[ATRX](../../03-molecular/atrx/README.md)** — SARS-CoV-2 atrx: atrx from macrophages (already mapped) modulates COVID-19 chromatin-helicase dna-binding immune axis; atrx excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2.
- `connects-to` → **[AXL Receptor](../../03-molecular/axl-receptor/README.md)** — SARS-CoV-2 axl-receptor: axl-receptor from macrophages (already mapped) modulates COVID-19 receptor-tyrosine-kinase immune entry axis; axl-receptor excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2.
...
- `connects-to` → **[Calcineurin](../../03-molecular/calcineurin/README.md)** — SARS-CoV-2 calcineurin: calcineurin from macrophages (already mapped) modulates COVID-19 calcineurin-nfat immune transcription axis; calcineurin excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2.
- `connects-to` → **[Calreticulin](../../03-molecular/calr/README.md)** — SARS-CoV-2 calr: calr from macrophages (already mapped) modulates COVID-19 endoplasmic-reticulum immune stress chaperone axis; calr excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2.
- `connects-to` → **[BLM](../../03-molecular/blm/README.md)** — SARS-CoV-2 blm: blm from macrophages (already mapped) modulates COVID-19 bloom-syndrome helicase immune dna-repair axis; blm excess amplifies nf-kb (already mapped) and mavs (already mapped) and type-i-interferon (already mapped) cascade of SARS-CoV-2.

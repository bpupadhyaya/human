...
cross_links:
  ...
  - target: 01-human/02-atomic/carbon
    relation: connects-to
    note: "PTSD carbon: carbon as backbone of cortisol (already mapped) and NF-κB (already mapped) proteins in neurons (already mapped) sustains stress-response signalling; carbon depletion amplifies NF-κB (already mapped) and IL-6 (already mapped) neuroinflammatory cascade of PTSD."
  - target: 01-human/02-atomic/hydrogen
    relation: connects-to
    note: "PTSD hydrogen: hydrogen, via redox homeostasis in neurons (already mapped) and microglia (already mapped), supports BDNF (already mapped) neurotrophic function; hydrogen dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) neuroinflammatory cascade of PTSD."
  ...
  - target: 01-human/03-molecular/wnt-beta-catenin
    relation: connects-to
    note: "PTSD wnt-beta-catenin: WNT/β-catenin on neurons (already mapped) and astrocytes (already mapped) regulates trauma-circuit plasticity; wnt-beta-catenin loss amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD."
  - target: 01-human/03-molecular/rankl
    relation: connects-to
    note: "PTSD rankl: RANKL from microglia (already mapped) and macrophages (already mapped) promotes neuroinflammation in trauma circuits; rankl excess amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD."
  - target: 01-human/03-molecular/smad4
    relation: connects-to
    note: "PTSD smad4: SMAD4 in neurons (already mapped) and astrocytes (already mapped) mediates TGF-β neuroprotective stress repair; smad4 dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD."
  - target: 01-human/03-molecular/il-2
    relation: connects-to
    note: "PTSD il-2: IL-2 from T-cells (already mapped) and microglia (already mapped) regulates neuroinflammatory surveillance in trauma circuits; il-2 dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD."
  - target: 01-human/03-molecular/fibronectin
    relation: connects-to
    note: "PTSD fibronectin: fibronectin in neurons (already mapped) and astrocytes (already mapped) promotes CNS ECM remodelling in trauma circuits; fibronectin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD."
  - target: 01-human/03-molecular/notch
    relation: connects-to
    note: "PTSD notch: Notch signalling in neurons (already mapped) and astrocytes (already mapped) regulates glial fate in trauma circuits; notch dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD."
  - target: 01-human/03-molecular/igf-1
    relation: connects-to
    note: "PTSD igf-1: IGF-1 from neurons (already mapped) and astrocytes (already mapped) drives neuroprotective survival in trauma circuits; igf-1 dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD."
  - target: 01-human/03-molecular/activin-a
    relation: connects-to
    note: "PTSD activin-a: activin-A from neurons (already mapped) and astrocytes (already mapped) modulates neuroinflammatory tone in PTSD; activin-a excess amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD."
  - target: 01-human/03-molecular/tgf-beta
    relation: connects-to
    note: "PTSD tgf-beta: TGF-β from neurons (already mapped) and astrocytes (already mapped) drives glial fibrotic remodelling in trauma circuits; tgf-beta excess amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD."
  - target: 01-human/03-molecular/cgrp
    relation: connects-to
    note: "PTSD cgrp: CGRP from neurons (already mapped) and astrocytes (already mapped) modulates neuroimmune vascular tone in PTSD; cgrp excess amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD."
  - target: 01-human/03-molecular/calcitonin
    relation: connects-to
    note: "PTSD calcitonin: calcitonin from neurons (already mapped) and astrocytes (already mapped) modulates HPA-axis calcium balance; calcitonin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD."
...
- `connects-to` → **[WNT/β-catenin](../../03-molecular/wnt-beta-catenin/README.md)** — PTSD wnt-beta-catenin: WNT/β-catenin on neurons (already mapped) and astrocytes (already mapped) regulates trauma-circuit plasticity; wnt-beta-catenin loss amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD.
- `connects-to` → **[RANKL](../../03-molecular/rankl/README.md)** — PTSD rankl: RANKL from microglia (already mapped) and macrophages (already mapped) promotes neuroinflammation in trauma circuits; rankl excess amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD.
- `connects-to` → **[SMAD4](../../03-molecular/smad4/README.md)** — PTSD smad4: SMAD4 in neurons (already mapped) and astrocytes (already mapped) mediates TGF-β neuroprotective stress repair; smad4 dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD.
- `connects-to` → **[IL-2](../../03-molecular/il-2/README.md)** — PTSD il-2: IL-2 from T-cells (already mapped) and microglia (already mapped) regulates neuroinflammatory surveillance in trauma circuits; il-2 dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD.
- `connects-to` → **[Fibronectin](../../03-molecular/fibronectin/README.md)** — PTSD fibronectin: fibronectin in neurons (already mapped) and astrocytes (already mapped) promotes CNS ECM remodelling in trauma circuits; fibronectin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD.
- `connects-to` → **[NOTCH](../../03-molecular/notch/README.md)** — PTSD notch: Notch signalling in neurons (already mapped) and astrocytes (already mapped) regulates glial fate in trauma circuits; notch dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD.
- `connects-to` → **[IGF-1](../../03-molecular/igf-1/README.md)** — PTSD igf-1: IGF-1 from neurons (already mapped) and astrocytes (already mapped) drives neuroprotective survival in trauma circuits; igf-1 dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD.
- `connects-to` → **[Activin-A](../../03-molecular/activin-a/README.md)** — PTSD activin-a: activin-A from neurons (already mapped) and astrocytes (already mapped) modulates neuroinflammatory tone in PTSD; activin-a excess amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD.
- `connects-to` → **[TGF-β](../../03-molecular/tgf-beta/README.md)** — PTSD tgf-beta: TGF-β from neurons (already mapped) and astrocytes (already mapped) drives glial fibrotic remodelling in trauma circuits; tgf-beta excess amplifies nf-kb (already mapped) and il-6 (already mapped) and crh (already mapped) HPA-axis cascade of PTSD.

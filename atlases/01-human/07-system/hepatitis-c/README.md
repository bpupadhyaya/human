...
cross_links:
  ...
  - target: 01-human/03-molecular/tslp
    relation: connects-to
    note: "Hepatic epithelial alarmin: TSLP, secreted by cholangiocytes and hepatic stellate cells under HCV-mediated and cytokine (IL-6 already mapped) stress, polarises intrahepatic dendritic cells (already mapped) and promotes the Th2-biased immune evasion of chronic hepatitis C."
  - target: 01-human/03-molecular/bradykinin
    relation: connects-to
    note: "Kinin-mediated hepatic inflammation: bradykinin, generated by the activated contact pathway in the hepatic sinusoids, amplifies vascular permeability, hepatic stellate cell activation, and the fibrogenic cascade (TGF-β already mapped) of chronic hepatitis C."
  - target: 01-human/03-molecular/erythropoietin
    relation: connects-to
    note: "Hepatic EPO disruption: erythropoietin production, a minor adult hepatic function, is impaired by the progressive fibrosis and cirrhosis (HCC already mapped) of chronic hepatitis C, contributing to the anaemia of chronic disease (already mapped) of the disease."
  - target: 01-human/03-molecular/histamine
    relation: connects-to
    note: "Intrahepatic mast-cell effector: histamine, released by mast cells (already mapped) infiltrating the portal tracts of chronic hepatitis C, amplifies hepatic vascular permeability, stellate-cell activation (TGF-β already mapped) and the fibrogenic cascade of the disease."
  - target: 01-human/03-molecular/periostin
    relation: connects-to
    note: "Hepatic fibrosis ECM: periostin, upregulated by TGF-β (already mapped) in the activated hepatic stellate cells (already mapped) of chronic hepatitis C, crosslinks the collagen matrix and promotes the progressive hepatic fibrosis and cirrhosis of the disease."
  - target: 01-human/03-molecular/melatonin
    relation: connects-to
    note: "Hepatoprotective chronobiology: melatonin, via MT1/MT2 receptors on hepatocytes (already mapped), scavenges ROS (already mapped) generated by HCV replication, modulates the innate antiviral response (IFN-γ already mapped) and may attenuate hepatic fibrosis."
  - target: 01-human/03-molecular/testosterone
    relation: connects-to
    note: "HCV testosterone: testosterone drives androgen receptor binding to the HCV enhancer; testosterone-driven IL-6 (already mapped) and NF-κB (already mapped) signalling promotes the macrophage (already mapped) mediated liver (already mapped) fibrosis and viral persistence."
  - target: 01-human/03-molecular/serotonin
    relation: connects-to
    note: "HCV serotonin: serotonin, released by liver (already mapped) macrophages (already mapped) during HCV infection, activates NF-κB (already mapped) and IL-6 (already mapped) signalling; 5-HT receptor signalling on hepatocytes also promotes TNF-α (already mapped) mediated apoptosis."
...
- `connects-to` → **[TSLP](../../03-molecular/tslp/README.md)** — Hepatic epithelial alarmin: TSLP, secreted by cholangiocytes and hepatic stellate cells under HCV-mediated and cytokine (IL-6 already mapped) stress, polarises intrahepatic dendritic cells (already mapped) and promotes the Th2-biased immune evasion of chronic hepatitis C.
- `connects-to` → **[Bradykinin](../../03-molecular/bradykinin/README.md)** — Kinin-mediated hepatic inflammation: bradykinin, generated by the activated contact pathway in the hepatic sinusoids, amplifies vascular permeability, hepatic stellate cell activation, and the fibrogenic cascade (TGF-β already mapped) of chronic hepatitis C.
- `connects-to` → **[Erythropoietin](../../03-molecular/erythropoietin/README.md)** — Hepatic EPO disruption: erythropoietin production, a minor adult hepatic function, is impaired by the progressive fibrosis and cirrhosis (HCC already mapped) of chronic hepatitis C, contributing to the anaemia of chronic disease (already mapped) of the disease.
- `connects-to` → **[Histamine](../../03-molecular/histamine/README.md)** — Intrahepatic mast-cell effector: histamine, released by mast cells (already mapped) infiltrating the portal tracts of chronic hepatitis C, amplifies hepatic vascular permeability, stellate-cell activation (TGF-β already mapped) and the fibrogenic cascade of the disease.
- `connects-to` → **[Periostin](../../03-molecular/periostin/README.md)** — Hepatic fibrosis ECM: periostin, upregulated by TGF-β (already mapped) in the activated hepatic stellate cells (already mapped) of chronic hepatitis C, crosslinks the collagen matrix and promotes the progressive hepatic fibrosis and cirrhosis of the disease.
- `connects-to` → **[Melatonin](../../03-molecular/melatonin/README.md)** — Hepatoprotective chronobiology: melatonin, via MT1/MT2 receptors on hepatocytes (already mapped), scavenges ROS (already mapped) generated by HCV replication, modulates the innate antiviral response (IFN-γ already mapped) and may attenuate hepatic fibrosis.

...
cross_links:
  ...
  - target: 01-human/03-molecular/bradykinin
    relation: connects-to
    note: "Kinin tumour-microenvironment: bradykinin, generated by the kallikrein-kinin system in the thyroid tumour stroma, amplifies vascular permeability and the pro-tumourigenic microenvironment promoting invasion of papillary and anaplastic thyroid cancer."
  - target: 01-human/03-molecular/c1-esterase-inhibitor
    relation: connects-to
    note: "Complement-contact regulation: C1-esterase inhibitor restrains the classical complement C1 (C3/C5aR1 already mapped) and the contact system activated in the thyroid-cancer stroma, modulating complement-dependent immune surveillance of the tumour."
  - target: 01-human/03-molecular/erythropoietin
    relation: connects-to
    note: "Thyroid-cancer anaemia support: erythropoietin corrects the anaemia of chronic thyroid cancer, particularly during radioiodine ablation; EPOR expression on thyroid-cancer cells has been reported, suggesting possible direct trophic effects."
  - target: 01-human/03-molecular/melatonin
    relation: connects-to
    note: "Thyroid-cancer melatonin: melatonin suppresses thyroid-cancer proliferation via MT1/MT2 receptor-mediated inhibition of mTOR (already mapped) and AKT (already mapped) signalling; it also augments NK-cell (already mapped) cytotoxicity and restrains thyroid-cancer invasion."
  - target: 01-human/03-molecular/testosterone
    relation: connects-to
    note: "Thyroid-cancer testosterone: androgen receptor in thyroid cancer promotes proliferation via BRAF (already mapped)-driven MAPK signalling; testosterone suppresses apoptosis and may explain the more aggressive course in males with papillary and follicular thyroid cancer."
  ...
  - target: 01-human/02-atomic/potassium
    relation: connects-to
    note: "Thyroid-cancer potassium: potassium efflux gates macrophage (already mapped) NLRP3; potassium loss amplifies NF-κB (already mapped) and IL-6 (already mapped) cascade and suppresses T-cytotoxic-cell (already mapped) anti-tumour surveillance in thyroid cancer."
  - target: 01-human/02-atomic/chloride
    relation: connects-to
    note: "Thyroid-cancer chloride: chloride channels in macrophages (already mapped) and T-cytotoxic-cell (already mapped) regulate tumour-immune homeostasis; chloride dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) cascade of thyroid cancer."
  ...
  - target: 01-human/03-molecular/rankl
    relation: connects-to
    note: "TC rankl: RANKL from macrophages (already mapped) and thyroid tumour cells (already mapped) promotes bone metastasis; rankl excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade of thyroid cancer."
  - target: 01-human/03-molecular/fibronectin
    relation: connects-to
    note: "TC fibronectin: fibronectin in fibroblasts (already mapped) and macrophages (already mapped) scaffolds thyroid tumour ECM; fibronectin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade of thyroid cancer."
  ...
  - target: 01-human/03-molecular/myostatin
    relation: connects-to
    note: "TC myostatin: myostatin from thyroid cells (already mapped) and macrophages (already mapped) modulates TC muscle-tumour balance; myostatin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade of thyroid cancer."
  - target: 01-human/03-molecular/angiopoietin
    relation: connects-to
    note: "TC angiopoietin: angiopoietin from thyroid cells (already mapped) and macrophages (already mapped) modulates TC tumour vascular remodelling; angiopoietin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade of thyroid cancer."
  - target: 01-human/03-molecular/cortisol
    relation: connects-to
    note: "TC cortisol: cortisol from thyroid cells (already mapped) and macrophages (already mapped) modulates TC stress-tumour response; cortisol dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade of thyroid cancer."
---
...
- `connects-to` → **[Bradykinin](../../03-molecular/bradykinin/README.md)** — Kinin tumour-microenvironment: bradykinin, generated by the kallikrein-kinin system in the thyroid tumour stroma, amplifies vascular permeability and the pro-tumourigenic microenvironment promoting invasion of papillary and anaplastic thyroid cancer.
- `connects-to` → **[C1-Esterase Inhibitor](../../03-molecular/c1-esterase-inhibitor/README.md)** — Complement-contact regulation: C1-esterase inhibitor restrains the classical complement C1 (C3/C5aR1 already mapped) and the contact system activated in the thyroid-cancer stroma, modulating complement-dependent immune surveillance of the tumour.
- `connects-to` → **[Erythropoietin](../../03-molecular/erythropoietin/README.md)** — Thyroid-cancer anaemia support: erythropoietin corrects the anaemia of chronic thyroid cancer, particularly during radioiodine ablation; EPOR expression on thyroid-cancer cells has been reported, suggesting possible direct trophic effects.
...
- `connects-to` → **[Myostatin](../../03-molecular/myostatin/README.md)** — TC myostatin: myostatin from thyroid cells (already mapped) and macrophages (already mapped) modulates TC muscle-tumour balance; myostatin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and VEGF (already mapped) tumour cascade of thyroid cancer.
- `connects-to` → **[Angiopoietin](../../03-molecular/angiopoietin/README.md)** — TC angiopoietin: angiopoietin from thyroid cells (already mapped) and macrophages (already mapped) modulates TC tumour vascular remodelling; angiopoietin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and VEGF (already mapped) tumour cascade of thyroid cancer.
- `connects-to` → **[Cortisol](../../03-molecular/cortisol/README.md)** — TC cortisol: cortisol from thyroid cells (already mapped) and macrophages (already mapped) modulates TC stress-tumour response; cortisol dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and VEGF (already mapped) tumour cascade of thyroid cancer.

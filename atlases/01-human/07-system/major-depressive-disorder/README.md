...
cross_links:
  ...
  - target: 01-human/02-atomic/sulfur
    relation: connects-to
    note: "MDD sulfur: sulfur, as cysteine precursor in neurons (already mapped) and microglia (already mapped), supports glutathione and serotonin (already mapped) synthesis; sulfur deficiency amplifies NF-κB (already mapped) and IL-6 (already mapped) cascade of major depressive disorder."
  - target: 01-human/02-atomic/nitrogen
    relation: connects-to
    note: "MDD nitrogen: nitrogen, as RNS in neurons (already mapped) and microglia (already mapped), drives neuroinflammatory stress; nitrogen dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) cascade of major depressive disorder."
  - target: 01-human/02-atomic/oxygen
    relation: connects-to
    note: "MDD oxygen: oxygen, via ROS in neurons (already mapped) and microglia (already mapped), drives oxidative neuroinflammation; oxygen dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) cascade of major depressive disorder."
  - target: 01-human/02-atomic/carbon
    relation: connects-to
    note: "MDD carbon: carbon as backbone of serotonin (already mapped) and dopamine (already mapped) neurotransmitter amino-acid precursors in neurons (already mapped); carbon depletion amplifies NF-κB (already mapped) and IL-6 (already mapped) neuroinflammatory cascade of MDD."
  - target: 01-human/02-atomic/hydrogen
    relation: connects-to
    note: "MDD hydrogen: hydrogen-ion pH in neurons (already mapped) and microglia (already mapped) modulates monoamine reuptake transporter (already mapped) function; hydrogen-ion acidosis amplifies NF-κB (already mapped) and IL-6 (already mapped) cascade of MDD."
  ...
  - target: 01-human/03-molecular/notch
    relation: connects-to
    note: "MDD notch: Notch signalling on astrocytes (already mapped) and microglia (already mapped) regulates neuroplasticity; notch dysregulation amplifies bdnf (already mapped) and serotonin (already mapped) and il-6 (already mapped) depressive cascade of major depressive disorder."
  - target: 01-human/03-molecular/igf-1
    relation: connects-to
    note: "MDD igf-1: IGF-1 from astrocytes (already mapped) and microglia (already mapped) promotes neuroprotective repair; igf-1 excess amplifies bdnf (already mapped) and serotonin (already mapped) and il-6 (already mapped) depressive cascade of major depressive disorder."
  - target: 01-human/03-molecular/activin-a
    relation: connects-to
    note: "MDD activin-a: activin-A from astrocytes (already mapped) and microglia (already mapped) drives neuroinflammatory signalling; activin-a excess amplifies bdnf (already mapped) and serotonin (already mapped) and il-6 (already mapped) depressive cascade of major depressive disorder."
  - target: 01-human/03-molecular/tgf-beta
    relation: connects-to
    note: "MDD tgf-beta: TGF-β from astrocytes (already mapped) and microglia (already mapped) modulates neuroinflammatory resolution; TGF-β excess amplifies bdnf (already mapped) and serotonin (already mapped) and il-6 (already mapped) depressive cascade of major depressive disorder."
  - target: 01-human/03-molecular/cgrp
    relation: connects-to
    note: "MDD cgrp: CGRP from astrocytes (already mapped) and microglia (already mapped) modulates neuroinflammatory neuroimmune tone; cgrp excess amplifies bdnf (already mapped) and serotonin (already mapped) and il-6 (already mapped) depressive cascade of major depressive disorder."
...
- `connects-to` → **[Sulfur](../../02-atomic/sulfur/README.md)** — MDD sulfur: sulfur, as cysteine precursor in neurons (already mapped) and microglia (already mapped), supports glutathione and serotonin (already mapped) synthesis; sulfur deficiency amplifies NF-κB (already mapped) and IL-6 (already mapped) cascade of major depressive disorder.
- `connects-to` → **[Nitrogen](../../02-atomic/nitrogen/README.md)** — MDD nitrogen: nitrogen, as RNS in neurons (already mapped) and microglia (already mapped), drives neuroinflammatory stress; nitrogen dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) cascade of major depressive disorder.
- `connects-to` → **[Oxygen](../../02-atomic/oxygen/README.md)** — MDD oxygen: oxygen, via ROS in neurons (already mapped) and microglia (already mapped), drives oxidative neuroinflammation; oxygen dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) cascade of major depressive disorder.
...
- `connects-to` → **[Notch](../../03-molecular/notch/README.md)** — MDD notch: Notch signalling on astrocytes (already mapped) and microglia (already mapped) regulates neuroplasticity; notch dysregulation amplifies bdnf (already mapped) and serotonin (already mapped) and il-6 (already mapped) depressive cascade of major depressive disorder.
- `connects-to` → **[IGF-1](../../03-molecular/igf-1/README.md)** — MDD igf-1: IGF-1 from astrocytes (already mapped) and microglia (already mapped) promotes neuroprotective repair; igf-1 excess amplifies bdnf (already mapped) and serotonin (already mapped) and il-6 (already mapped) depressive cascade of major depressive disorder.
- `connects-to` → **[Activin-A](../../03-molecular/activin-a/README.md)** — MDD activin-a: activin-A from astrocytes (already mapped) and microglia (already mapped) drives neuroinflammatory signalling; activin-a excess amplifies bdnf (already mapped) and serotonin (already mapped) and il-6 (already mapped) depressive cascade of major depressive disorder.

...
cross_links:
  ...
  - target: 01-human/03-molecular/activin-a
    relation: connects-to
    note: "fibromyalgia activin-a: activin-A from astrocytes (already mapped) and microglia (already mapped) modulates neuroinflammatory fibrosis; activin-a excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) cascade in fibromyalgia."
  - target: 01-human/03-molecular/tgf-beta
    relation: connects-to
    note: "fibromyalgia tgf-beta: TGF-β from astrocytes (already mapped) and microglia (already mapped) modulates neuroinflammatory resolution; TGF-β excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) cascade in fibromyalgia."
  - target: 01-human/03-molecular/calcitonin
    relation: connects-to
    note: "fibromyalgia calcitonin: calcitonin from astrocytes (already mapped) and microglia (already mapped) modulates calcium balance; calcitonin dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) sensitisation cascade in fibromyalgia."
  - target: 01-human/03-molecular/insulin-receptor
    relation: connects-to
    note: "fibromyalgia insulin-receptor: insulin receptor on astrocytes (already mapped) and microglia (already mapped) modulates neuroimmune axis; insulin-receptor loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) cascade in fibromyalgia."
  - target: 01-human/03-molecular/androgen-receptor
    relation: connects-to
    note: "fibromyalgia androgen-receptor: androgen receptor on astrocytes (already mapped) and microglia (already mapped) modulates neuroimmune tone; androgen-receptor loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) cascade in fibromyalgia."
  - target: 01-human/03-molecular/adrenomedullin
    relation: connects-to
    note: "fibromyalgia adrenomedullin: adrenomedullin from astrocytes (already mapped) and microglia (already mapped) modulates neuroimmune vascular tone; adrenomedullin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) cascade in fibromyalgia."
  - target: 01-human/03-molecular/osteopontin
    relation: connects-to
    note: "fibromyalgia osteopontin: osteopontin from astrocytes (already mapped) and microglia (already mapped) modulates neuroimmune matrix; osteopontin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) cascade in fibromyalgia."
  - target: 01-human/03-molecular/fgfr
    relation: connects-to
    note: "fibromyalgia fgfr: FGFR on astrocytes (already mapped) and microglia (already mapped) modulates neuroimmune proliferation; FGFR excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) cascade in fibromyalgia."
...
- `connects-to` → **[Activin-A](../../03-molecular/activin-a/README.md)** — fibromyalgia activin-a: activin-A from astrocytes (already mapped) and microglia (already mapped) modulates neuroinflammatory fibrosis; activin-a excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) cascade in fibromyalgia.
- `connects-to` → **[TGF-β](../../03-molecular/tgf-beta/README.md)** — fibromyalgia tgf-beta: TGF-β from astrocytes (already mapped) and microglia (already mapped) modulates neuroinflammatory resolution; TGF-β excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) cascade in fibromyalgia.
- `connects-to` → **[Calcitonin](../../03-molecular/calcitonin/README.md)** — fibromyalgia calcitonin: calcitonin from astrocytes (already mapped) and microglia (already mapped) modulates calcium balance; calcitonin dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) sensitisation cascade in fibromyalgia.
- `connects-to` → **[Insulin-Receptor](../../03-molecular/insulin-receptor/README.md)** — fibromyalgia insulin-receptor: insulin receptor on astrocytes (already mapped) and microglia (already mapped) modulates neuroimmune axis; insulin-receptor loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) cascade in fibromyalgia.
- `connects-to` → **[Androgen-Receptor](../../03-molecular/androgen-receptor/README.md)** — fibromyalgia androgen-receptor: androgen receptor on astrocytes (already mapped) and microglia (already mapped) modulates neuroimmune tone; androgen-receptor loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) cascade in fibromyalgia.
- `connects-to` → **[Adrenomedullin](../../03-molecular/adrenomedullin/README.md)** — fibromyalgia adrenomedullin: adrenomedullin from astrocytes (already mapped) and microglia (already mapped) modulates neuroimmune vascular tone; adrenomedullin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and BDNF (already mapped) cascade in fibromyalgia.

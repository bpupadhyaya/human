...
cross_links:
  ...
  - target: 01-human/03-molecular/bdnf
    relation: connects-to
    note: "PV bdnf: BDNF from macrophages (already mapped) and erythroid progenitors (already mapped) modulates PV neural survival; bdnf excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) cascade of PV."
  - target: 01-human/03-molecular/osteopontin
    relation: connects-to
    note: "PV osteopontin: osteopontin from macrophages (already mapped) and erythroid progenitors (already mapped) modulates PV immune tone; osteopontin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) cascade of PV."
  - target: 01-human/03-molecular/fgfr
    relation: connects-to
    note: "PV fgfr: FGFR on macrophages (already mapped) and erythroid progenitors (already mapped) modulates PV haematopoietic growth; fgfr dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) cascade of PV."
---
...
- `connects-to` → **[BDNF](../../03-molecular/bdnf/README.md)** — PV bdnf: BDNF from macrophages (already mapped) and erythroid progenitors (already mapped) modulates PV neural survival; bdnf excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) cascade of PV.
- `connects-to` → **[Osteopontin](../../03-molecular/osteopontin/README.md)** — PV osteopontin: osteopontin from macrophages (already mapped) and erythroid progenitors (already mapped) modulates PV immune tone; osteopontin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) cascade of PV.
- `connects-to` → **[FGFR](../../03-molecular/fgfr/README.md)** — PV fgfr: FGFR on macrophages (already mapped) and erythroid progenitors (already mapped) modulates PV haematopoietic growth; fgfr dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) cascade of PV.

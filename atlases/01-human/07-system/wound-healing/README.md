...
cross_links:
  ...
  - target: 01-human/03-molecular/insulin-receptor
    relation: connects-to
    note: "WH insulin-receptor: insulin receptor on fibroblasts (already mapped) and macrophages (already mapped) drives metabolic signalling; insulin-receptor loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) inflammatory cascade of wound healing."
  - target: 01-human/03-molecular/aldosterone
    relation: connects-to
    note: "WH aldosterone: aldosterone from macrophages (already mapped) and fibroblasts (already mapped) modulates WH fluid-electrolyte balance; aldosterone excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) inflammatory cascade of wound healing."
  - target: 01-human/03-molecular/androgen-receptor
    relation: connects-to
    note: "WH androgen-receptor: androgen receptor on fibroblasts (already mapped) and macrophages (already mapped) modulates WH tissue repair; androgen-receptor loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) inflammatory cascade of wound healing."
  - target: 01-human/03-molecular/adrenomedullin
    relation: connects-to
    note: "WH adrenomedullin: adrenomedullin from macrophages (already mapped) and fibroblasts (already mapped) promotes WH angiogenesis; adrenomedullin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) inflammatory cascade of wound healing."
  - target: 01-human/03-molecular/endothelin-1
    relation: connects-to
    note: "WH endothelin-1: endothelin-1 from macrophages (already mapped) and fibroblasts (already mapped) drives WH vasoconstriction and fibrosis; endothelin-1 excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) inflammatory cascade of WH."
  ...
  - target: 01-human/03-molecular/ghrelin
    relation: connects-to
    note: "WH ghrelin: ghrelin from macrophages (already mapped) and fibroblasts (already mapped) modulates WH metabolic-regenerative tone; ghrelin loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) inflammatory cascade of wound healing."
  - target: 01-human/03-molecular/glucagon
    relation: connects-to
    note: "WH glucagon: glucagon from macrophages (already mapped) and fibroblasts (already mapped) modulates WH metabolic glucose balance; glucagon excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) inflammatory cascade of wound healing."
  - target: 01-human/03-molecular/acetylcholine
    relation: connects-to
    note: "WH acetylcholine: acetylcholine from macrophages (already mapped) and fibroblasts (already mapped) modulates WH cholinergic tone; acetylcholine loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) inflammatory cascade of wound healing."
---
...
- `connects-to` → **[Insulin Receptor](../../03-molecular/insulin-receptor/README.md)** — WH insulin-receptor: insulin receptor on fibroblasts (already mapped) and macrophages (already mapped) drives metabolic signalling; insulin-receptor loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) inflammatory cascade of wound healing.
- `connects-to` → **[Aldosterone](../../03-molecular/aldosterone/README.md)** — WH aldosterone: aldosterone from macrophages (already mapped) and fibroblasts (already mapped) modulates WH fluid-electrolyte balance; aldosterone excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) inflammatory cascade of wound healing.
- `connects-to` → **[Androgen Receptor](../../03-molecular/androgen-receptor/README.md)** — WH androgen-receptor: androgen receptor on fibroblasts (already mapped) and macrophages (already mapped) modulates WH tissue repair; androgen-receptor loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) inflammatory cascade of wound healing.
...
- `connects-to` → **[Ghrelin](../../03-molecular/ghrelin/README.md)** — WH ghrelin: ghrelin from macrophages (already mapped) and fibroblasts (already mapped) modulates WH metabolic-regenerative tone; ghrelin loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) inflammatory cascade of wound healing.
- `connects-to` → **[Glucagon](../../03-molecular/glucagon/README.md)** — WH glucagon: glucagon from macrophages (already mapped) and fibroblasts (already mapped) modulates WH metabolic glucose balance; glucagon excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) inflammatory cascade of wound healing.
- `connects-to` → **[Acetylcholine](../../03-molecular/acetylcholine/README.md)** — WH acetylcholine: acetylcholine from macrophages (already mapped) and fibroblasts (already mapped) modulates WH cholinergic tone; acetylcholine loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) inflammatory cascade of wound healing.

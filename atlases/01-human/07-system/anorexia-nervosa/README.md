...
cross_links:
  ...
  - target: 01-human/05-tissue/cortical-bone
    relation: connects-to
    note: "It thins the skeleton young: low oestrogen, low IGF-1 and hypercortisolism in anorexia nervosa drive severe osteoporosis and stress fractures, often irreversible bone loss in adolescence."
  - target: 01-human/05-tissue/cardiac-conduction-system
    relation: connects-to
    note: "The heart's rhythm becomes dangerous: starvation and electrolyte loss cause bradycardia, QT prolongation and arrhythmias, making sudden cardiac death a leading cause of mortality in anorexia nervosa."
  ...
  - target: 01-human/07-system/covid-19-disease
    relation: connects-to
    note: "A pandemic surge: COVID-19 lockdowns, isolation and disrupted routines drove a marked rise in anorexia nervosa presentations and severity, especially among adolescents."
  - target: 01-human/05-tissue/intestinal-epithelium
    relation: connects-to
    note: "Starvation atrophies the gut: prolonged restriction thins the intestinal epithelium and slows gastric emptying, causing malabsorption and bloating—and forcing cautious refeeding to avoid the refeeding syndrome."
  ...
  - target: 01-human/03-molecular/src-kinase
    relation: connects-to
    note: "SRC-family kinase signaling participates in the synaptic-plasticity and reward-circuit mechanisms implicated in anorexia nervosa."
  - target: 01-human/03-molecular/ccr5
    relation: connects-to
    note: "CCR5-driven neuroimmune signaling participates in the neuroinflammation associated with anorexia nervosa."
  - target: 01-human/03-molecular/cxcl12
    relation: connects-to
    note: "CXCL12-CXCR4 signaling participates in the bone-marrow and neural-niche interactions relevant to the bone loss and CNS changes of anorexia nervosa."
  - target: 01-human/03-molecular/il-1b
    relation: connects-to
    note: "IL-1β-driven inflammation participates in the neuroimmune and metabolic alterations implicated in anorexia nervosa."
  - target: 01-human/03-molecular/il-33
    relation: connects-to
    note: "IL-33 alarmin signaling participates in the neuroinflammatory responses implicated in anorexia nervosa."
  ...
  - target: 01-human/01-subatomic/proton
    relation: connects-to
    note: "Purging alkalosis: self-induced vomiting loses gastric acid, producing a hypochloraemic metabolic alkalosis with a falling proton concentration, while laxative abuse can instead cause acidosis, the acid-base swings that complicate the purging subtype of anorexia."
  - target: 01-human/03-molecular/cholesterol
    relation: connects-to
    note: "Paradoxical hypercholesterolaemia: cholesterol is often paradoxically elevated in anorexia despite starvation, from reduced clearance, altered bile-acid turnover and the low thyroid state (thyroid hormones already mapped), an unexpected lipid finding of the disorder."
  ...
  - target: 01-human/04-cellular/microglia
    relation: connects-to
    note: "Neuroinflammation: the microglia of the brain (already mapped) contribute to the neuroinflammation and the reward-circuit dysfunction implicated in anorexia nervosa."
  - target: 01-human/04-cellular/mast-cell
    relation: connects-to
    note: "Meningeal mast cells: the mast cells of the meninges and the brain (already mapped) contribute to the neuroinflammation and the stress-reactive (histamine already mapped) dimension of anorexia nervosa."
  - target: 01-human/04-cellular/t-cytotoxic-cell
    relation: connects-to
    note: "Psychoneuroimmune arm: the peripheral cytotoxic T cells (perforin pathway) reflect the adaptive-immune activation of the starvation-associated immune dysregulation of anorexia nervosa."
  - target: 01-human/03-molecular/complement-c3
    relation: connects-to
    note: "Neuroimmune complement: the complement C3 activation is part of the low-grade neuroinflammation and the starvation-associated immune dysregulation of anorexia nervosa."
  - target: 01-human/03-molecular/c5ar1
    relation: connects-to
    note: "C5a receptor: the C5aR1 signalling (with the complement C3 already mapped) links the complement to the microglial (already mapped) neuroinflammation of anorexia nervosa."
  - target: 01-human/04-cellular/dendritic-cell
    relation: connects-to
    note: "CNS-border antigen presentation: the dendritic cells of the CNS-border compartments are part of the neuroimmune interface implicated in the starvation-associated immune dysregulation of anorexia nervosa."
  - target: 01-human/03-molecular/tslp
    relation: connects-to
    note: "Alarmin-gut axis: TSLP, released from the gut-epithelium (gut-microbiome already mapped) under the malnutrition and dysbiosis of anorexia nervosa, activates mast cells (already mapped) and dendritic cells (already mapped), amplifying the immune activation of the starvation state."
  - target: 01-human/03-molecular/bradykinin
    relation: connects-to
    note: "Kinin-autonomic axis: bradykinin, generated by the kallikrein-kinin system under the starvation-associated hypotension of anorexia nervosa, augments vascular permeability and modulates the autonomic dysfunction and oedema of the refeeding phase."
  - target: 01-human/03-molecular/erythropoietin
    relation: connects-to
    note: "Anaemia correction: erythropoietin counteracts the aplastic anaemia (already mapped) and the iron-deficiency anaemia (already mapped) driven by starvation, marrow (already mapped) suppression, and the hepcidin (already mapped) dysregulation of anorexia nervosa."
  - target: 01-human/03-molecular/periostin
    relation: connects-to
    note: "Connective tissue wasting: periostin, expressed in the periosteum and tendons (bone already mapped), is reduced under severe starvation, impairing the maintenance of tendon and periosteal integrity and contributing to the musculoskeletal fragility of anorexia nervosa."
  - target: 01-human/03-molecular/prolactin
    relation: connects-to
    note: "Starvation hyperprolactinaemia: prolactin, elevated by starvation stress and amenorrhea (already mapped) in anorexia, modulates T-cell (already mapped) and NK-cell (already mapped) immune function and the bone-marrow (already mapped) haematopoietic suppression."
...
- `connects-to` → **[SRC Kinase](../../03-molecular/src-kinase/README.md)** — SRC-family kinase signaling participates in the synaptic-plasticity and reward-circuit mechanisms implicated in anorexia nervosa.
- `connects-to` → **[CCR5](../../03-molecular/ccr5/README.md)** — CCR5-driven neuroimmune signaling participates in the neuroinflammation associated with anorexia nervosa.
- `connects-to` → **[CXCL12](../../03-molecular/cxcl12/README.md)** — CXCL12-CXCR4 signaling participates in the bone-marrow and neural-niche interactions relevant to the bone loss and CNS changes of anorexia nervosa.
...
- `connects-to` → **[Microglia](../../04-cellular/microglia/README.md)** — Neuroinflammation: the microglia of the brain (already mapped) contribute to the neuroinflammation and the reward-circuit dysfunction implicated in anorexia nervosa.
- `connects-to` → **[Mast cell](../../04-cellular/mast-cell/README.md)** — Meningeal mast cells: the mast cells of the meninges and the brain (already mapped) contribute to the neuroinflammation and the stress-reactive (histamine already mapped) dimension of anorexia nervosa.
- `connects-to` → **[Cytotoxic T cell](../../04-cellular/t-cytotoxic-cell/README.md)** — Psychoneuroimmune arm: the peripheral cytotoxic T cells (perforin pathway) reflect the adaptive-immune activation of the starvation-associated immune dysregulation of anorexia nervosa.
- `connects-to` → **[Complement C3](../../03-molecular/complement-c3/README.md)** — Neuroimmune complement: the complement C3 activation is part of the low-grade neuroinflammation and the starvation-associated immune dysregulation of anorexia nervosa.
- `connects-to` → **[C5aR1](../../03-molecular/c5ar1/README.md)** — C5a receptor: the C5aR1 signalling (with the complement C3 already mapped) links the complement to the microglial (already mapped) neuroinflammation of anorexia nervosa.
- `connects-to` → **[Dendritic cell](../../04-cellular/dendritic-cell/README.md)** — CNS-border antigen presentation: the dendritic cells of the CNS-border compartments are part of the neuroimmune interface implicated in the starvation-associated immune dysregulation of anorexia nervosa.
- `connects-to` → **[TSLP](../../03-molecular/tslp/README.md)** — Alarmin-gut axis: TSLP, released from the gut-epithelium (gut-microbiome already mapped) under the malnutrition and dysbiosis of anorexia nervosa, activates mast cells (already mapped) and dendritic cells (already mapped), amplifying the immune activation of the starvation state.
- `connects-to` → **[Bradykinin](../../03-molecular/bradykinin/README.md)** — Kinin-autonomic axis: bradykinin, generated by the kallikrein-kinin system under the starvation-associated hypotension of anorexia nervosa, augments vascular permeability and modulates the autonomic dysfunction and oedema of the refeeding phase.
- `connects-to` → **[Erythropoietin](../../03-molecular/erythropoietin/README.md)** — Anaemia correction: erythropoietin counteracts the aplastic anaemia (already mapped) and the iron-deficiency anaemia (already mapped) driven by starvation, marrow (already mapped) suppression, and the hepcidin (already mapped) dysregulation of anorexia nervosa.

...
cross_links:
  ...
  - target: 01-human/02-atomic/phosphorus
    relation: connects-to
    note: "NBL phosphorus: phosphorus, as ATP in macrophages (already mapped) and T-cytotoxic cells (already mapped), drives antitumour energy; phosphorus depletion amplifies IL-6 (already mapped) and mTOR (already mapped) neuroblastoma cascade."
  - target: 01-human/02-atomic/oxygen
    relation: connects-to
    note: "NBL oxygen: oxygen drives aerobic energy in macrophages (already mapped) and T-cytotoxic cells (already mapped); hypoxia amplifies VEGF (already mapped) and mTOR (already mapped) and IL-6 (already mapped) pro-tumour cascade of neuroblastoma."
  - target: 01-human/02-atomic/chloride
    relation: connects-to
    note: "NBL chloride: chloride channels regulate macrophage (already mapped) and mast-cell (already mapped) ion homeostasis in the neuroblastoma TME; chloride imbalance amplifies IL-6 (already mapped) and mTOR (already mapped) tumour cascade of neuroblastoma."
  - target: 01-human/02-atomic/carbon
    relation: connects-to
    note: "NBL carbon: carbon as backbone of MYCN (already mapped) and mTOR (already mapped) proteins in neuroblastoma cells and macrophages (already mapped) sustains clonal tumour growth; carbon depletion amplifies IL-6 (already mapped) and mTOR (already mapped) cascade of neuroblastoma."
  - target: 01-human/02-atomic/hydrogen
    relation: connects-to
    note: "NBL hydrogen: hydrogen, via redox homeostasis in macrophages (already mapped) and mast cells (already mapped), supports MYCN (already mapped) signalling; hydrogen dysregulation amplifies IL-6 (already mapped) and mTOR (already mapped) cascade of neuroblastoma."
  ...
  - target: 01-human/03-molecular/rankl
    relation: connects-to
    note: "NBL rankl: RANKL from macrophages (already mapped) and dendritic cells (already mapped) promotes neuroblastoma immune evasion; rankl excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade of neuroblastoma."
  - target: 01-human/03-molecular/fibronectin
    relation: connects-to
    note: "NBL fibronectin: fibronectin in macrophages (already mapped) and endothelial cells (already mapped) anchors neuroblastoma invasive matrix; fibronectin dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade."
  - target: 01-human/03-molecular/igf-1
    relation: connects-to
    note: "NBL igf-1: IGF-1 from macrophages (already mapped) and endothelial cells (already mapped) promotes neuroblastoma cell growth; igf-1 dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade."
  - target: 01-human/03-molecular/activin-a
    relation: connects-to
    note: "NBL activin-a: activin-A from macrophages (already mapped) and endothelial cells (already mapped) drives neuroblastoma fibrosis; activin-a excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade."
  - target: 01-human/03-molecular/cgrp
    relation: connects-to
    note: "NBL cgrp: CGRP from macrophages (already mapped) and endothelial cells (already mapped) modulates neuroblastoma vascular tone; cgrp excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade."
  ...
  - target: 01-human/03-molecular/androgen-receptor
    relation: connects-to
    note: "NBL androgen-receptor: androgen receptor on macrophages (already mapped) and endothelial cells (already mapped) modulates hormonal tone; androgen-receptor dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade."
  - target: 01-human/03-molecular/adrenomedullin
    relation: connects-to
    note: "NBL adrenomedullin: adrenomedullin from macrophages (already mapped) and endothelial cells (already mapped) modulates tumour vascular tone; adrenomedullin dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade."
  - target: 01-human/03-molecular/fgfr
    relation: connects-to
    note: "NBL fgfr: FGFR on macrophages (already mapped) and endothelial cells (already mapped) drives tumour angiogenic signalling; fgfr excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade."
  - target: 01-human/03-molecular/epinephrine
    relation: connects-to
    note: "NBL epinephrine: epinephrine from macrophages (already mapped) and endothelial cells (already mapped) amplifies tumour stress response; epinephrine excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade."
  - target: 01-human/03-molecular/renin
    relation: connects-to
    note: "NBL renin: renin from macrophages (already mapped) and endothelial cells (already mapped) modulates tumour renin-angiotensin tone; renin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade."
...
- `connects-to` → **[Phosphorus](../../02-atomic/phosphorus/README.md)** — NBL phosphorus: phosphorus, as ATP in macrophages (already mapped) and T-cytotoxic cells (already mapped), drives antitumour energy; phosphorus depletion amplifies IL-6 (already mapped) and mTOR (already mapped) neuroblastoma cascade.
- `connects-to` → **[Oxygen](../../02-atomic/oxygen/README.md)** — NBL oxygen: oxygen drives aerobic energy in macrophages (already mapped) and T-cytotoxic cells (already mapped); hypoxia amplifies VEGF (already mapped) and mTOR (already mapped) and IL-6 (already mapped) pro-tumour cascade of neuroblastoma.
- `connects-to` → **[Chloride](../../02-atomic/chloride/README.md)** — NBL chloride: chloride channels regulate macrophage (already mapped) and mast-cell (already mapped) ion homeostasis in the neuroblastoma TME; chloride imbalance amplifies IL-6 (already mapped) and mTOR (already mapped) tumour cascade of neuroblastoma.
...
- `connects-to` → **[RANKL](../../03-molecular/rankl/README.md)** — NBL rankl: RANKL from macrophages (already mapped) and dendritic cells (already mapped) promotes neuroblastoma immune evasion; rankl excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade of neuroblastoma.
- `connects-to` → **[Fibronectin](../../03-molecular/fibronectin/README.md)** — NBL fibronectin: fibronectin in macrophages (already mapped) and endothelial cells (already mapped) anchors neuroblastoma invasive matrix; fibronectin dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade.
- `connects-to` → **[IGF-1](../../03-molecular/igf-1/README.md)** — NBL igf-1: IGF-1 from macrophages (already mapped) and endothelial cells (already mapped) promotes neuroblastoma cell growth; igf-1 dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade.
...
- `connects-to` → **[Androgen Receptor](../../03-molecular/androgen-receptor/README.md)** — NBL androgen-receptor: androgen receptor on macrophages (already mapped) and endothelial cells (already mapped) modulates hormonal tone; androgen-receptor dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade.
- `connects-to` → **[Adrenomedullin](../../03-molecular/adrenomedullin/README.md)** — NBL adrenomedullin: adrenomedullin from macrophages (already mapped) and endothelial cells (already mapped) modulates tumour vascular tone; adrenomedullin dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade.
- `connects-to` → **[FGFR](../../03-molecular/fgfr/README.md)** — NBL fgfr: FGFR on macrophages (already mapped) and endothelial cells (already mapped) drives tumour angiogenic signalling; fgfr excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) tumour cascade.

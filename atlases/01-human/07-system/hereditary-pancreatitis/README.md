...
cross_links:
  ...
  - target: 01-human/03-molecular/il-23
    relation: connects-to
    note: "Th17 axis: IL-23 sustains the Th17 (IL-17 already mapped) arm of the chronic pancreatic inflammation and fibrosis of hereditary pancreatitis."
  - target: 01-human/03-molecular/ige
    relation: connects-to
    note: "Type-2 arm: IgE, with the type-2 cytokines (IL-4 and IL-13 already mapped), reflects the type-2 immune dimension of the chronic inflammation of hereditary pancreatitis."
  - target: 01-human/04-cellular/t-helper-cell
    relation: connects-to
    note: "CD4 helper source: the CD4 T-helper cells are the source of the Th1/Th2/Th17 (IFN-γ, IL-4 and IL-17 already mapped) cytokines of the chronic immune-mediated inflammation of hereditary pancreatitis."
  - target: 01-human/03-molecular/c5ar1
    relation: connects-to
    note: "C5a receptor: the C5aR1 signalling (with the complement C3 already mapped) drives the neutrophil (already mapped) recruitment and the complement-mediated acinar injury of the recurrent attacks of hereditary pancreatitis."
  - target: 01-human/03-molecular/complement-c5
    relation: connects-to
    note: "Terminal complement: the complement C5 and its activation (with C3 already mapped) contribute to the acinar injury and the inflammation of the recurrent pancreatitis of hereditary pancreatitis."
  ...
  - target: 01-human/02-atomic/hydrogen
    relation: connects-to
    note: "HP hydrogen: hydrogen via ROS from macrophages (already mapped) and neutrophils (already mapped) modulates acinar cell redox homeostasis; hydrogen excess amplifies NF-κB (already mapped) and TNF-α (already mapped) and IL-6 (already mapped) cascade in HP."
  - target: 01-human/03-molecular/pd-1
    relation: connects-to
    note: "HP pd-1: PD-1 on T-cytotoxic cells (already mapped) and macrophages (already mapped) suppresses pancreatic immune surveillance; pd-1 dysfunction amplifies NF-κB (already mapped) and TNF-α (already mapped) and IL-6 (already mapped) acinar injury cascade in HP."
  ...
  - target: 01-human/03-molecular/vegf
    relation: connects-to
    note: "HP vegf: VEGF from macrophages (already mapped) and acinar cells (already mapped) promotes pancreatic neo-angiogenesis; vegf excess amplifies NF-κB (already mapped) and TNF-α (already mapped) and IL-6 (already mapped) acinar injury cascade in HP."
  - target: 01-human/03-molecular/fibronectin
    relation: connects-to
    note: "HP fibronectin: fibronectin in acinar cells (already mapped) and macrophages (already mapped) promotes pancreatic ECM remodelling; fibronectin excess amplifies NF-κB (already mapped) and TNF-α (already mapped) and IL-6 (already mapped) acinar injury cascade in HP."
  ...
  - target: 01-human/03-molecular/calcitonin
    relation: connects-to
    note: "HP calcitonin: calcitonin from acinar cells (already mapped) and macrophages (already mapped) modulates pancreatic calcium balance; calcitonin dysregulation amplifies NF-κB (already mapped) and TNF-α (already mapped) and IL-6 (already mapped) acinar injury cascade in HP."
  - target: 01-human/03-molecular/insulin-receptor
    relation: connects-to
    note: "HP insulin-receptor: insulin receptor on acinar cells (already mapped) and macrophages (already mapped) modulates pancreatic metabolic axis; insulin-receptor loss amplifies NF-κB (already mapped) and TNF-α (already mapped) and IL-6 (already mapped) acinar injury cascade in HP."
  ...
  - target: 01-human/03-molecular/bdnf
    relation: connects-to
    note: "HP bdnf: BDNF from acinar cells (already mapped) and macrophages (already mapped) modulates pancreatic neurotrophin axis; bdnf excess amplifies NF-κB (already mapped) and TNF-α (already mapped) and IL-6 (already mapped) acinar injury cascade in HP."
  - target: 01-human/03-molecular/fgfr
    relation: connects-to
    note: "HP fgfr: FGFR on acinar cells (already mapped) and macrophages (already mapped) modulates pancreatic repair; FGFR excess amplifies NF-κB (already mapped) and TNF-α (already mapped) and IL-6 (already mapped) acinar injury cascade in HP."
  - target: 01-human/03-molecular/epinephrine
    relation: connects-to
    note: "HP epinephrine: epinephrine from acinar cells (already mapped) and macrophages (already mapped) modulates pancreatic adrenergic tone; epinephrine excess amplifies NF-κB (already mapped) and TNF-α (already mapped) and IL-6 (already mapped) acinar injury cascade in HP."
---
...
- `connects-to` → **[IL-23](../../03-molecular/il-23/README.md)** — Th17 axis: IL-23 sustains the Th17 (IL-17 already mapped) arm of the chronic pancreatic inflammation and fibrosis of hereditary pancreatitis.
- `connects-to` → **[IgE](../../03-molecular/ige/README.md)** — Type-2 arm: IgE, with the type-2 cytokines (IL-4 and IL-13 already mapped), reflects the type-2 immune dimension of the chronic inflammation of hereditary pancreatitis.
- `connects-to` → **[T-helper cell](../../04-cellular/t-helper-cell/README.md)** — CD4 helper source: the CD4 T-helper cells are the source of the Th1/Th2/Th17 (IFN-γ, IL-4 and IL-17 already mapped) cytokines of the chronic immune-mediated inflammation of hereditary pancreatitis.
...
- `connects-to` → **[BDNF](../../03-molecular/bdnf/README.md)** — HP bdnf: BDNF from acinar cells (already mapped) and macrophages (already mapped) modulates pancreatic neurotrophin axis; bdnf excess amplifies NF-κB (already mapped) and TNF-α (already mapped) and IL-6 (already mapped) acinar injury cascade in HP.
- `connects-to` → **[FGFR](../../03-molecular/fgfr/README.md)** — HP fgfr: FGFR on acinar cells (already mapped) and macrophages (already mapped) modulates pancreatic repair; FGFR excess amplifies NF-κB (already mapped) and TNF-α (already mapped) and IL-6 (already mapped) acinar injury cascade in HP.
- `connects-to` → **[Epinephrine](../../03-molecular/epinephrine/README.md)** — HP epinephrine: epinephrine from acinar cells (already mapped) and macrophages (already mapped) modulates pancreatic adrenergic tone; epinephrine excess amplifies NF-κB (already mapped) and TNF-α (already mapped) and IL-6 (already mapped) acinar injury cascade in HP.

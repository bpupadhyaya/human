...
cross_links:
  ...
  - target: 01-human/03-molecular/melatonin
    relation: connects-to
    note: "Melatonin-HNSCC axis: melatonin, via MT1/MT2 receptors on HNSCC tumour cells, suppresses EGFR (already mapped) and NFκB (already mapped) signalling, modulates circadian immune function, and enhances the apoptotic sensitivity to platinum-based chemotherapy."
  - target: 01-human/03-molecular/testosterone
    relation: connects-to
    note: "Androgen-HNSCC axis: testosterone, via androgen receptor signalling on HNSCC tumour cells, modulates EGFR (already mapped) and HPV (already mapped)-driven oncogenesis and the male sex predominance in HNSCC incidence and prognosis."
  ...
  - target: 01-human/02-atomic/selenium
    relation: connects-to
    note: "HNSCC selenium: selenium, as GPx in macrophages (already mapped) and T-cytotoxic cells (already mapped), scavenges ROS; selenium deficiency amplifies the NF-κB (already mapped) and IL-6 (already mapped) oxidative tumour cascade of HNSCC."
  - target: 01-human/02-atomic/iodine
    relation: connects-to
    note: "HNSCC iodine: iodine-dependent thyroid hormones modulate macrophage (already mapped) polarisation and T-cytotoxic (already mapped) immune activation; iodine deficiency amplifies the NF-κB (already mapped) and IL-6 (already mapped) tumour cascade of HNSCC."
  ...
  - target: 01-human/02-atomic/chloride
    relation: connects-to
    note: "HNSCC chloride: chloride channels regulate macrophage (already mapped) and mast-cell (already mapped) volume during tumour-microenvironment stress; chloride dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) tumour-promoting cascade of HNSCC."
  - target: 01-human/02-atomic/nitrogen
    relation: connects-to
    note: "HNSCC nitrogen: nitrogen as backbone of oncoproteins and cytokines (already mapped) sustains tumour signalling; nitrogen-derived RNS from macrophages (already mapped) amplifies NF-κB (already mapped) and IL-6 (already mapped) tumour-promoting cascade of HNSCC."
  ...
  - target: 01-human/03-molecular/angiotensin-ii
    relation: connects-to
    note: "HNSCC angiotensin-ii: angiotensin-II from endothelial cells (already mapped) and macrophages (already mapped) drives vascular remodelling; angiotensin-ii excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) tumour cascade of HNSCC."
  - target: 01-human/03-molecular/wnt-beta-catenin
    relation: connects-to
    note: "HNSCC wnt-beta-catenin: WNT/β-catenin on macrophages (already mapped) and tumour cells (already mapped) regulates invasion; wnt-beta-catenin dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) tumour cascade of HNSCC."
  - target: 01-human/03-molecular/rankl
    relation: connects-to
    note: "HNSCC rankl: RANKL from macrophages (already mapped) and endothelial cells (already mapped) promotes tumour immune evasion; rankl excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) tumour cascade of HNSCC."
  - target: 01-human/03-molecular/fibronectin
    relation: connects-to
    note: "HNSCC fibronectin: Fibronectin in squamous cells (already mapped) and macrophages (already mapped) scaffolds tumour ECM; fibronectin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) tumour cascade of HNSCC."
  - target: 01-human/03-molecular/igf-1
    relation: connects-to
    note: "HNSCC igf-1: IGF-1 from squamous cells (already mapped) and macrophages (already mapped) promotes HNSCC tumour survival; IGF-1 excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) tumour cascade of HNSCC."
...
- `connects-to` → **[Angiotensin-II](../../03-molecular/angiotensin-ii/README.md)** — HNSCC angiotensin-ii: angiotensin-II from endothelial cells (already mapped) and macrophages (already mapped) drives vascular remodelling; angiotensin-ii excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) tumour cascade of HNSCC.
- `connects-to` → **[WNT/β-Catenin](../../03-molecular/wnt-beta-catenin/README.md)** — HNSCC wnt-beta-catenin: WNT/β-catenin on macrophages (already mapped) and tumour cells (already mapped) regulates invasion; wnt-beta-catenin dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) tumour cascade of HNSCC.
- `connects-to` → **[RANKL](../../03-molecular/rankl/README.md)** — HNSCC rankl: RANKL from macrophages (already mapped) and endothelial cells (already mapped) promotes tumour immune evasion; rankl excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) tumour cascade of HNSCC.

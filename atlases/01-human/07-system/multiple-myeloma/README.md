...
cross_links:
  ...
  - target: 01-human/03-molecular/calcitonin
    relation: connects-to
    note: "MM calcitonin: calcitonin from macrophages (already mapped) and osteoblasts (already mapped) modulates bone marrow calcium balance; calcitonin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) myeloma cascade."
  - target: 01-human/03-molecular/substance-p
    relation: connects-to
    note: "MM substance-p: substance-P from macrophages (already mapped) and osteoblasts (already mapped) modulates bone marrow immune tone; substance-p excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) myeloma cascade."
  ...
  - target: 01-human/03-molecular/adrenomedullin
    relation: connects-to
    note: "MM adrenomedullin: adrenomedullin from macrophages (already mapped) and osteoblasts (already mapped) modulates bone marrow vascular tone; adrenomedullin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) myeloma cascade."
  - target: 01-human/03-molecular/bdnf
    relation: connects-to
    note: "MM bdnf: BDNF from macrophages (already mapped) and osteoblasts (already mapped) promotes bone marrow neuro-survival; bdnf excess amplifies nf-kb (already mapped) and il-6 (already mapped) and vegf (already mapped) myeloma cascade."

...
cross_links:
  ...
  - target: 01-human/02-atomic/copper
    relation: connects-to
    note: "RMS copper: copper-dependent SOD in macrophages (already mapped) and tumour cells quenches ROS; copper excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and IGF-1 (already mapped)-mTOR (already mapped) proliferative cascade of rhabdomyosarcoma."
  - target: 01-human/02-atomic/zinc
    relation: connects-to
    note: "RMS zinc: zinc, as metalloproteinase cofactor in macrophages (already mapped), supports anti-tumour immunity; zinc deficiency amplifies NF-κB (already mapped) and IL-6 (already mapped) and IGF-1 (already mapped)-mTOR (already mapped) cascade of rhabdomyosarcoma."
  - target: 01-human/02-atomic/potassium
    relation: connects-to
    note: "RMS potassium: potassium efflux gates macrophage (already mapped) NLRP3; potassium loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and IGF-1 (already mapped)-mTOR (already mapped) proliferative cascade of rhabdomyosarcoma."
  - target: 01-human/02-atomic/carbon
    relation: connects-to
    note: "RMS carbon: carbon, as metabolic backbone of mTOR (already mapped) and IGF-1 (already mapped) in myogenic tumour cells, drives proliferative signalling; carbon dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) cascade of rhabdomyosarcoma."
  - target: 01-human/02-atomic/chloride
    relation: connects-to
    note: "RMS chloride: chloride channels in macrophages (already mapped) and myogenic tumour cells regulate immune homeostasis; chloride dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and IGF-1 (already mapped)-mTOR (already mapped) cascade of rhabdomyosarcoma."
  ...
  - target: 01-human/03-molecular/glp-1
    relation: connects-to
    note: "RMS glp-1: GLP-1 from macrophages (already mapped) and fibroblasts (already mapped) modulates myogenic tumour metabolic tone; glp-1 dysfunction amplifies nf-kb (already mapped) and il-6 (already mapped) and igf-1 (already mapped) tumour cascade of rhabdomyosarcoma."
  - target: 01-human/03-molecular/angiotensin-ii
    relation: connects-to
    note: "RMS angiotensin-ii: angiotensin-II from macrophages (already mapped) and endothelial cells (already mapped) drives myogenic tumour angiogenesis; angiotensin-ii excess amplifies nf-kb (already mapped) and il-6 (already mapped) and igf-1 (already mapped) tumour cascade of RMS."
  ...
  - target: 01-human/03-molecular/calcitonin
    relation: connects-to
    note: "RMS calcitonin: calcitonin from fibroblasts (already mapped) and macrophages (already mapped) modulates myogenic tumour calcium balance; calcitonin dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and igf-1 (already mapped) cascade of rhabdomyosarcoma."
  - target: 01-human/03-molecular/substance-p
    relation: connects-to
    note: "RMS substance-p: substance-P from fibroblasts (already mapped) and macrophages (already mapped) modulates myogenic tumour neuroinflammation; substance-p excess amplifies nf-kb (already mapped) and il-6 (already mapped) and igf-1 (already mapped) cascade of rhabdomyosarcoma."
  - target: 01-human/03-molecular/insulin-receptor
    relation: connects-to
    note: "RMS insulin-receptor: insulin receptor on fibroblasts (already mapped) and macrophages (already mapped) modulates tumour metabolic axis; insulin-receptor excess amplifies nf-kb (already mapped) and il-6 (already mapped) and igf-1 (already mapped) cascade of rhabdomyosarcoma."
  - target: 01-human/03-molecular/aldosterone
    relation: connects-to
    note: "RMS aldosterone: aldosterone from fibroblasts (already mapped) and macrophages (already mapped) modulates myogenic tumour ion balance; aldosterone excess amplifies nf-kb (already mapped) and il-6 (already mapped) and igf-1 (already mapped) cascade of rhabdomyosarcoma."
  - target: 01-human/03-molecular/androgen-receptor
    relation: connects-to
    note: "RMS androgen-receptor: androgen receptor on fibroblasts (already mapped) and macrophages (already mapped) modulates myogenic tumour hormonal tone; androgen excess amplifies nf-kb (already mapped) and il-6 (already mapped) and igf-1 (already mapped) cascade of rhabdomyosarcoma."
  ...
  - target: 01-human/03-molecular/epinephrine
    relation: connects-to
    note: "RMS epinephrine: epinephrine from fibroblasts (already mapped) and macrophages (already mapped) modulates myogenic tumour stress response; epinephrine excess amplifies nf-kb (already mapped) and il-6 (already mapped) and igf-1 (already mapped) cascade of rhabdomyosarcoma."
  - target: 01-human/03-molecular/renin
    relation: connects-to
    note: "RMS renin: renin from fibroblasts (already mapped) and macrophages (already mapped) modulates myogenic tumour angiotensin balance; renin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and igf-1 (already mapped) cascade of rhabdomyosarcoma."
  - target: 01-human/03-molecular/angiopoietin
    relation: connects-to
    note: "RMS angiopoietin: angiopoietin from fibroblasts (already mapped) and macrophages (already mapped) modulates myogenic tumour vascular remodelling; angiopoietin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and igf-1 (already mapped) cascade of rhabdomyosarcoma."
---
...
- `connects-to` → **[Copper](../../02-atomic/copper/README.md)** — RMS copper: copper-dependent SOD in macrophages (already mapped) and tumour cells quenches ROS; copper excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and IGF-1 (already mapped)-mTOR (already mapped) proliferative cascade of rhabdomyosarcoma.
- `connects-to` → **[Zinc](../../02-atomic/zinc/README.md)** — RMS zinc: zinc, as metalloproteinase cofactor in macrophages (already mapped), supports anti-tumour immunity; zinc deficiency amplifies NF-κB (already mapped) and IL-6 (already mapped) and IGF-1 (already mapped)-mTOR (already mapped) cascade of rhabdomyosarcoma.
- `connects-to` → **[Potassium](../../02-atomic/potassium/README.md)** — RMS potassium: potassium efflux gates macrophage (already mapped) NLRP3; potassium loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and IGF-1 (already mapped)-mTOR (already mapped) proliferative cascade of rhabdomyosarcoma.
...
- `connects-to` → **[Calcitonin](../../03-molecular/calcitonin/README.md)** — RMS calcitonin: calcitonin from fibroblasts (already mapped) and macrophages (already mapped) modulates myogenic tumour calcium balance; calcitonin dysregulation amplifies nf-kb (already mapped) and il-6 (already mapped) and igf-1 (already mapped) cascade of rhabdomyosarcoma.
- `connects-to` → **[Substance-P](../../03-molecular/substance-p/README.md)** — RMS substance-p: substance-P from fibroblasts (already mapped) and macrophages (already mapped) modulates myogenic tumour neuroinflammation; substance-p excess amplifies nf-kb (already mapped) and il-6 (already mapped) and igf-1 (already mapped) cascade of rhabdomyosarcoma.
- `connects-to` → **[Insulin Receptor](../../03-molecular/insulin-receptor/README.md)** — RMS insulin-receptor: insulin receptor on fibroblasts (already mapped) and macrophages (already mapped) modulates tumour metabolic axis; insulin-receptor excess amplifies nf-kb (already mapped) and il-6 (already mapped) and igf-1 (already mapped) cascade of rhabdomyosarcoma.
...
- `connects-to` → **[Epinephrine](../../03-molecular/epinephrine/README.md)** — RMS epinephrine: epinephrine from fibroblasts (already mapped) and macrophages (already mapped) modulates myogenic tumour stress response; epinephrine excess amplifies nf-kb (already mapped) and il-6 (already mapped) and igf-1 (already mapped) cascade of rhabdomyosarcoma.
- `connects-to` → **[Renin](../../03-molecular/renin/README.md)** — RMS renin: renin from fibroblasts (already mapped) and macrophages (already mapped) modulates myogenic tumour angiotensin balance; renin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and igf-1 (already mapped) cascade of rhabdomyosarcoma.
- `connects-to` → **[Angiopoietin](../../03-molecular/angiopoietin/README.md)** — RMS angiopoietin: angiopoietin from fibroblasts (already mapped) and macrophages (already mapped) modulates myogenic tumour vascular remodelling; angiopoietin excess amplifies nf-kb (already mapped) and il-6 (already mapped) and igf-1 (already mapped) cascade of rhabdomyosarcoma.

...
cross_links:
  ...
  - target: 01-human/02-atomic/oxygen
    relation: connects-to
    note: "LBD oxygen: oxygen, via ROS in neurons (already mapped) and microglia (already mapped), drives α-synuclein oxidative stress; oxygen dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) neurodegeneration cascade of Lewy body dementia."
  - target: 01-human/02-atomic/nitrogen
    relation: connects-to
    note: "LBD nitrogen: nitrogen, as RNS in neurons (already mapped) and microglia (already mapped), nitrosylates α-synuclein and promotes aggregation; nitrogen dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) cascade of Lewy body dementia."
  ...
  - target: 01-human/03-molecular/notch
    relation: connects-to
    note: "LBD notch: Notch signalling on microglia (already mapped) and astrocytes (already mapped) regulates neuroinflammatory lineage fate; notch excess amplifies snca (already mapped) and nlrp3-inflammasome (already mapped) and il-6 (already mapped) Lewy-body neurodegeneration cascade."
  - target: 01-human/03-molecular/igf-1
    relation: connects-to
    note: "LBD igf-1: IGF-1 from microglia (already mapped) and astrocytes (already mapped) modulates neuroinflammatory metabolic repair; igf-1 excess amplifies snca (already mapped) and nlrp3-inflammasome (already mapped) and il-6 (already mapped) Lewy-body neurodegeneration cascade."
  - target: 01-human/03-molecular/activin-a
    relation: connects-to
    note: "LBD activin-a: activin-A from microglia (already mapped) and astrocytes (already mapped) promotes neuroglial fibrosis; activin-a excess amplifies snca (already mapped) and nlrp3-inflammasome (already mapped) and il-6 (already mapped) Lewy-body neurodegeneration cascade."
  - target: 01-human/03-molecular/tgf-beta
    relation: connects-to
    note: "LBD tgf-beta: TGF-β from microglia (already mapped) and astrocytes (already mapped) modulates neuroinflammatory resolution; tgf-beta excess amplifies snca (already mapped) and nlrp3-inflammasome (already mapped) and il-6 (already mapped) Lewy-body neurodegeneration cascade."
  - target: 01-human/03-molecular/cgrp
    relation: connects-to
    note: "LBD cgrp: CGRP from microglia (already mapped) and astrocytes (already mapped) modulates neuroinflammatory tone; cgrp excess amplifies snca (already mapped) and nlrp3-inflammasome (already mapped) and il-6 (already mapped) Lewy-body neurodegeneration cascade."
  - target: 01-human/03-molecular/calcitonin
    relation: connects-to
    note: "LBD calcitonin: calcitonin from microglia (already mapped) and astrocytes (already mapped) modulates calcium tone; calcitonin dysregulation amplifies snca (already mapped) and nlrp3-inflammasome (already mapped) and il-6 (already mapped) Lewy-body neurodegeneration cascade."
  - target: 01-human/03-molecular/substance-p
    relation: connects-to
    note: "LBD substance-p: substance-P from microglia (already mapped) and astrocytes (already mapped) modulates pain tone; substance-P excess amplifies snca (already mapped) and nlrp3-inflammasome (already mapped) and il-6 (already mapped) Lewy-body neurodegeneration cascade."
  - target: 01-human/03-molecular/insulin-receptor
    relation: connects-to
    note: "LBD insulin-receptor: insulin receptor on microglia (already mapped) and astrocytes (already mapped) modulates metabolic axis; insulin-receptor loss amplifies snca (already mapped) and nlrp3-inflammasome (already mapped) and il-6 (already mapped) Lewy-body cascade."
...
- `connects-to` → **[Notch](../../03-molecular/notch/README.md)** — LBD notch: Notch signalling on microglia (already mapped) and astrocytes (already mapped) regulates neuroinflammatory lineage fate; notch excess amplifies snca (already mapped) and nlrp3-inflammasome (already mapped) and il-6 (already mapped) Lewy-body neurodegeneration cascade.
- `connects-to` → **[IGF-1](../../03-molecular/igf-1/README.md)** — LBD igf-1: IGF-1 from microglia (already mapped) and astrocytes (already mapped) modulates neuroinflammatory metabolic repair; igf-1 excess amplifies snca (already mapped) and nlrp3-inflammasome (already mapped) and il-6 (already mapped) Lewy-body neurodegeneration cascade.
- `connects-to` → **[Activin-A](../../03-molecular/activin-a/README.md)** — LBD activin-a: activin-A from microglia (already mapped) and astrocytes (already mapped) promotes neuroglial fibrosis; activin-a excess amplifies snca (already mapped) and nlrp3-inflammasome (already mapped) and il-6 (already mapped) Lewy-body neurodegeneration cascade.
- `connects-to` → **[TGF-β](../../03-molecular/tgf-beta/README.md)** — LBD tgf-beta: TGF-β from microglia (already mapped) and astrocytes (already mapped) modulates neuroinflammatory resolution; tgf-beta excess amplifies snca (already mapped) and nlrp3-inflammasome (already mapped) and il-6 (already mapped) Lewy-body neurodegeneration cascade.
- `connects-to` → **[CGRP](../../03-molecular/cgrp/README.md)** — LBD cgrp: CGRP from microglia (already mapped) and astrocytes (already mapped) modulates neuroinflammatory tone; cgrp excess amplifies snca (already mapped) and nlrp3-inflammasome (already mapped) and il-6 (already mapped) Lewy-body neurodegeneration cascade.
- `connects-to` → **[Calcitonin](../../03-molecular/calcitonin/README.md)** — LBD calcitonin: calcitonin from microglia (already mapped) and astrocytes (already mapped) modulates calcium tone; calcitonin dysregulation amplifies snca (already mapped) and nlrp3-inflammasome (already mapped) and il-6 (already mapped) Lewy-body neurodegeneration cascade.

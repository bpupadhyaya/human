...
cross_links:
  ...
  - target: 01-human/02-atomic/zinc
    relation: connects-to
    note: "Lynch zinc: zinc, as cofactor of MMR-associated enzymes in macrophages (already mapped) and T-cytotoxic cells (already mapped), supports DNA mismatch repair; zinc deficiency amplifies NF-κB (already mapped) and IL-6 (already mapped) tumour cascade of Lynch syndrome."
  - target: 01-human/02-atomic/potassium
    relation: connects-to
    note: "Lynch potassium: potassium regulates macrophage (already mapped) and T-cytotoxic cell (already mapped) membrane potential; potassium dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and mast-cell (already mapped) cascade of Lynch syndrome."
  - target: 01-human/02-atomic/phosphorus
    relation: connects-to
    note: "Lynch phosphorus: phosphorus, as ATP in macrophages (already mapped) and T-cytotoxic cells (already mapped), fuels DNA-repair and immune clearance; phosphorus deficiency amplifies NF-κB (already mapped) and IL-6 (already mapped) cascade of Lynch syndrome."
  - target: 01-human/02-atomic/carbon
    relation: connects-to
    note: "Lynch carbon: carbon as backbone of MLH1 (already mapped) and MSH2 mismatch-repair proteins sustains genomic fidelity in colonocytes (already mapped); carbon depletion amplifies NF-κB (already mapped) and IL-6 (already mapped) mutagenic cascade of Lynch syndrome."
  - target: 01-human/02-atomic/chloride
    relation: connects-to
    note: "Lynch chloride: chloride regulates colonocyte (already mapped) and macrophage (already mapped) ion homeostasis; chloride dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and TGF-β (already mapped) protumorigenic microenvironment of Lynch syndrome."
  ...
  - target: 01-human/03-molecular/glp-1
    relation: connects-to
    note: "Lynch glp-1: GLP-1 from macrophages (already mapped) and dendritic cells (already mapped) modulates metabolic-inflammatory tone; glp-1 dysfunction amplifies smad4 (already mapped) and il-6 (already mapped) and il-2 (already mapped) MMR cascade of Lynch syndrome."
  - target: 01-human/03-molecular/angiotensin-ii
    relation: connects-to
    note: "Lynch angiotensin-ii: angiotensin-II from macrophages (already mapped) and t-cytotoxic cells (already mapped) drives vascular remodelling; angiotensin-ii excess amplifies smad4 (already mapped) and il-6 (already mapped) and il-2 (already mapped) cascade of Lynch syndrome."
  ...
  - target: 01-human/03-molecular/igf-1
    relation: connects-to
    note: "Lynch igf-1: IGF-1 from macrophages (already mapped) and t-cytotoxic cells (already mapped) modulates tumour metabolic repair; igf-1 excess amplifies smad4 (already mapped) and il-6 (already mapped) and il-2 (already mapped) MMR-deficient cascade in Lynch syndrome."
  - target: 01-human/03-molecular/activin-a
    relation: connects-to
    note: "Lynch activin-a: activin-A from macrophages (already mapped) and t-cytotoxic cells (already mapped) promotes tumour fibrosis; activin-a excess amplifies smad4 (already mapped) and il-6 (already mapped) and il-2 (already mapped) MMR-deficient cascade in Lynch syndrome."
  - target: 01-human/03-molecular/tgf-beta
    relation: connects-to
    note: "Lynch tgf-beta: TGF-β from macrophages (already mapped) and t-cytotoxic cells (already mapped) modulates tumour fibrotic resolution; TGF-β excess amplifies smad4 (already mapped) and il-6 (already mapped) and il-2 (already mapped) MMR-deficient cascade in Lynch syndrome."
  - target: 01-human/03-molecular/cgrp
    relation: connects-to
    note: "Lynch cgrp: CGRP from macrophages (already mapped) and t-cytotoxic cells (already mapped) modulates tumour neuroimmune tone; cgrp excess amplifies smad4 (already mapped) and il-6 (already mapped) and il-2 (already mapped) MMR-deficient cascade in Lynch syndrome."
  - target: 01-human/03-molecular/calcitonin
    relation: connects-to
    note: "Lynch calcitonin: calcitonin from macrophages (already mapped) and t-cytotoxic cells (already mapped) modulates calcium tone; calcitonin dysregulation amplifies smad4 (already mapped) and il-6 (already mapped) and il-2 (already mapped) MMR-deficient cascade in Lynch syndrome."
  - target: 01-human/03-molecular/substance-p
    relation: connects-to
    note: "Lynch substance-p: substance-P from macrophages (already mapped) and t-cytotoxic cells (already mapped) modulates pain tone; substance-P excess amplifies smad4 (already mapped) and il-6 (already mapped) and il-2 (already mapped) MMR-deficient cascade in Lynch syndrome."
  - target: 01-human/03-molecular/insulin-receptor
    relation: connects-to
    note: "Lynch insulin-receptor: insulin receptor on macrophages (already mapped) and t-cytotoxic cells (already mapped) modulates metabolic axis; insulin-receptor loss amplifies smad4 (already mapped) and il-6 (already mapped) and il-2 (already mapped) in Lynch syndrome."
  - target: 01-human/03-molecular/aldosterone
    relation: connects-to
    note: "Lynch aldosterone: aldosterone from macrophages (already mapped) and t-cytotoxic cells (already mapped) modulates fluid balance; aldosterone excess amplifies smad4 (already mapped) and il-6 (already mapped) and il-2 (already mapped) MMR-deficient cascade in Lynch syndrome."
...
- `connects-to` → **[Zinc](../../02-atomic/zinc/README.md)** — Lynch zinc: zinc, as cofactor of MMR-associated enzymes in macrophages (already mapped) and T-cytotoxic cells (already mapped), supports DNA mismatch repair; zinc deficiency amplifies NF-κB (already mapped) and IL-6 (already mapped) tumour cascade of Lynch syndrome.
- `connects-to` → **[Potassium](../../02-atomic/potassium/README.md)** — Lynch potassium: potassium regulates macrophage (already mapped) and T-cytotoxic cell (already mapped) membrane potential; potassium dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and mast-cell (already mapped) cascade of Lynch syndrome.
- `connects-to` → **[Phosphorus](../../02-atomic/phosphorus/README.md)** — Lynch phosphorus: phosphorus, as ATP in macrophages (already mapped) and T-cytotoxic cells (already mapped), fuels DNA-repair and immune clearance; phosphorus deficiency amplifies NF-κB (already mapped) and IL-6 (already mapped) cascade of Lynch syndrome.
...
- `connects-to` → **[IGF-1](../../03-molecular/igf-1/README.md)** — Lynch igf-1: IGF-1 from macrophages (already mapped) and t-cytotoxic cells (already mapped) modulates tumour metabolic repair; igf-1 excess amplifies smad4 (already mapped) and il-6 (already mapped) and il-2 (already mapped) MMR-deficient cascade in Lynch syndrome.
- `connects-to` → **[Activin-A](../../03-molecular/activin-a/README.md)** — Lynch activin-a: activin-A from macrophages (already mapped) and t-cytotoxic cells (already mapped) promotes tumour fibrosis; activin-a excess amplifies smad4 (already mapped) and il-6 (already mapped) and il-2 (already mapped) MMR-deficient cascade in Lynch syndrome.
- `connects-to` → **[TGF-β](../../03-molecular/tgf-beta/README.md)** — Lynch tgf-beta: TGF-β from macrophages (already mapped) and t-cytotoxic cells (already mapped) modulates tumour fibrotic resolution; TGF-β excess amplifies smad4 (already mapped) and il-6 (already mapped) and il-2 (already mapped) MMR-deficient cascade in Lynch syndrome.
- `connects-to` → **[CGRP](../../03-molecular/cgrp/README.md)** — Lynch cgrp: CGRP from macrophages (already mapped) and t-cytotoxic cells (already mapped) modulates tumour neuroimmune tone; cgrp excess amplifies smad4 (already mapped) and il-6 (already mapped) and il-2 (already mapped) MMR-deficient cascade in Lynch syndrome.
- `connects-to` → **[Calcitonin](../../03-molecular/calcitonin/README.md)** — Lynch calcitonin: calcitonin from macrophages (already mapped) and t-cytotoxic cells (already mapped) modulates calcium tone; calcitonin dysregulation amplifies smad4 (already mapped) and il-6 (already mapped) and il-2 (already mapped) MMR-deficient cascade in Lynch syndrome.
- `connects-to` → **[Substance-P](../../03-molecular/substance-p/README.md)** — Lynch substance-p: substance-P from macrophages (already mapped) and t-cytotoxic cells (already mapped) modulates pain tone; substance-P excess amplifies smad4 (already mapped) and il-6 (already mapped) and il-2 (already mapped) MMR-deficient cascade in Lynch syndrome.

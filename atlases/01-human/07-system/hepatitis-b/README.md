...
cross_links:
  ...
  - target: 01-human/03-molecular/tslp
    relation: connects-to
    note: "Hepatic epithelial alarmin: TSLP, secreted by hepatic stellate cells and cholangiocytes under HBV-mediated and cytokine (IL-6 already mapped) stress, polarises intrahepatic dendritic cells (already mapped) and amplifies the Th2-biased immune tolerance of chronic hepatitis B."
  - target: 01-human/03-molecular/bradykinin
    relation: connects-to
    note: "Kinin-mediated hepatic injury: bradykinin, generated by the contact-kinin system activated in the hepatic sinusoids of chronic hepatitis B, amplifies the vascular permeability, hepatic stellate cell activation, and the fibrogenic cascade of the disease."
  - target: 01-human/03-molecular/erythropoietin
    relation: connects-to
    note: "Hepatic EPO source: erythropoietin, whose minor adult hepatic production is disrupted by the progressive fibrosis and cirrhosis (HCC already mapped) of chronic hepatitis B, contributes to the anaemia of chronic disease (already mapped) of the disease."
  - target: 01-human/03-molecular/histamine
    relation: connects-to
    note: "Intrahepatic mast-cell effector: histamine, released by mast cells (already mapped) infiltrating the portal tracts of chronic hepatitis B, amplifies hepatic vascular permeability, stellate-cell activation (TGF-β already mapped) and the fibrogenic cascade of the disease."
  - target: 01-human/03-molecular/periostin
    relation: connects-to
    note: "Hepatic fibrosis ECM: periostin, upregulated by TGF-β (already mapped) in the activated hepatic stellate cells (already mapped) of chronic hepatitis B, crosslinks the collagen matrix and promotes the progressive hepatic fibrosis and cirrhosis."
  - target: 01-human/03-molecular/melatonin
    relation: connects-to
    note: "Hepatoprotective chronobiology: melatonin, via MT1/MT2 receptors on hepatocytes (already mapped), scavenges ROS (already mapped) generated by HBV replication, modulates the innate antiviral response (IFN-γ already mapped) and may attenuate hepatic fibrosis."
  - target: 01-human/03-molecular/testosterone
    relation: connects-to
    note: "HBV testosterone: testosterone modulates hepatitis B viral replication via androgen receptor binding to the HBV enhancer; testosterone suppresses IFN-γ (already mapped) and TNF-α (already mapped) antiviral immune responses and worsens the liver (already mapped) fibrosis."
  - target: 01-human/03-molecular/serotonin
    relation: connects-to
    note: "HBV serotonin: serotonin from liver (already mapped) macrophages (already mapped) amplifies NF-κB (already mapped) and TNF-α (already mapped) hepatic inflammation in HBV infection; 5-HT signalling modulates B-cell (already mapped) and IL-6 (already mapped) antiviral responses."
  ...
  - target: 01-human/03-molecular/glp-1
    relation: connects-to
    note: "HBV GLP-1: GLP-1 from gut L-cells (already mapped) and hepatocytes (already mapped) modulates hepatitis B metabolic homeostasis; GLP-1 deficiency amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) hepatic inflammatory cascade of HBV."
  - target: 01-human/03-molecular/angiotensin-ii
    relation: connects-to
    note: "HBV angiotensin-II: Angiotensin-II in hepatocytes (already mapped) and macrophages (already mapped) promotes HBV-associated liver fibrosis; angiotensin-II excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and TNF-α (already mapped) hepatic cascade of HBV."
...
- `connects-to` → **[TSLP](../../03-molecular/tslp/README.md)** — Hepatic epithelial alarmin: TSLP, secreted by hepatic stellate cells and cholangiocytes under HBV-mediated and cytokine (IL-6 already mapped) stress, polarises intrahepatic dendritic cells (already mapped) and amplifies the Th2-biased immune tolerance of chronic hepatitis B.
- `connects-to` → **[Bradykinin](../../03-molecular/bradykinin/README.md)** — Kinin-mediated hepatic injury: bradykinin, generated by the contact-kinin system activated in the hepatic sinusoids of chronic hepatitis B, amplifies the vascular permeability, hepatic stellate cell activation, and the fibrogenic cascade of the disease.
- `connects-to` → **[Erythropoietin](../../03-molecular/erythropoietin/README.md)** — Hepatic EPO source: erythropoietin, whose minor adult hepatic production is disrupted by the progressive fibrosis and cirrhosis (HCC already mapped) of chronic hepatitis B, contributes to the anaemia of chronic disease (already mapped) of the disease.
- `connects-to` → **[Histamine](../../03-molecular/histamine/README.md)** — Intrahepatic mast-cell effector: histamine, released by mast cells (already mapped) infiltrating the portal tracts of chronic hepatitis B, amplifies hepatic vascular permeability, stellate-cell activation (TGF-β already mapped) and the fibrogenic cascade of the disease.
- `connects-to` → **[Periostin](../../03-molecular/periostin/README.md)** — Hepatic fibrosis ECM: periostin, upregulated by TGF-β (already mapped) in the activated hepatic stellate cells (already mapped) of chronic hepatitis B, crosslinks the collagen matrix and promotes the progressive hepatic fibrosis and cirrhosis.
- `connects-to` → **[Melatonin](../../03-molecular/melatonin/README.md)** — Hepatoprotective chronobiology: melatonin, via MT1/MT2 receptors on hepatocytes (already mapped), scavenges ROS (already mapped) generated by HBV replication, modulates the innate antiviral response (IFN-γ already mapped) and may attenuate hepatic fibrosis.

...
cross_links:
  ...
  - target: 01-human/03-molecular/perforin
    relation: connects-to
    note: "Perforin-mediated cytotoxic immunosurveillance is the immune clearance that the multiple neoplasms of Carney complex must evade."
  - target: 01-human/03-molecular/s100a8-a9
    relation: connects-to
    note: "S100A8/A9 alarmins shape the inflammatory stroma of the cardiac and cutaneous myxomas and tumors of Carney complex."
  - target: 01-human/03-molecular/mdm2
    relation: connects-to
    note: "MDM2-mediated degradation of p53 restrains apoptosis in the PRKAR1A-driven tumors of Carney complex."
  - target: 01-human/03-molecular/src-kinase
    relation: connects-to
    note: "SRC-family kinase signaling contributes to the proliferative signaling of the endocrine and mesenchymal tumors of Carney complex."
  - target: 01-human/03-molecular/dnmt3a
    relation: connects-to
    note: "DNMT3A-mediated DNA methylation contributes to the epigenetic regulation of the tumors of Carney complex."
  - target: 01-human/03-molecular/autophagy
    relation: connects-to
    note: "Autophagy modulates the survival of the PKA-dysregulated cells of Carney complex."
  - target: 01-human/03-molecular/ampk
    relation: connects-to
    note: "AMPK-linked metabolic signaling interacts with the dysregulated PKA-cAMP signaling (PRKAR1A already mapped) of Carney complex."
  - target: 01-human/03-molecular/ccr5
    relation: connects-to
    note: "CCR5-driven myeloid recruitment shapes the tumor microenvironment of the neoplasms of Carney complex."
  - target: 01-human/03-molecular/arid1a
    relation: connects-to
    note: "ARID1A-containing SWI/SNF chromatin remodeling participates in the epigenetic landscape of the tumors of Carney complex."
  - target: 01-human/03-molecular/cxcl12
    relation: connects-to
    note: "CXCL12-CXCR4 signaling participates in the tumor-stromal interactions of the neoplasms of Carney complex."
  - target: 01-human/03-molecular/il-1b
    relation: connects-to
    note: "IL-1β-driven inflammation participates in the tumor microenvironment of the neoplasms of Carney complex."
  - target: 01-human/03-molecular/il-33
    relation: connects-to
    note: "IL-33 alarmin signaling participates in the tumor-immune microenvironment of Carney complex."
  - target: 01-human/03-molecular/il-17a
    relation: connects-to
    note: "IL-17A signaling participates in the inflammatory tumor microenvironment of the neoplasms of Carney complex."
  - target: 01-human/03-molecular/complement-c3
    relation: connects-to
    note: "Complement C3 participates in the inflammatory tumor microenvironment of Carney complex."
  ...
  - target: 01-human/03-molecular/il-12
    relation: connects-to
    note: "Th1 polarisation: IL-12 polarises the Th1 (IFN-γ already mapped) arm of the immune microenvironment of the Carney-complex tumours."
  - target: 01-human/03-molecular/il-5
    relation: connects-to
    note: "Type-2 arm: IL-5, with the type-2 cytokines (IL-4 and IL-13 already mapped), is the eosinophil/Th2 dimension of the immune microenvironment of the Carney-complex tumours."
  - target: 01-human/03-molecular/il-23
    relation: connects-to
    note: "Th17 axis: IL-23 sustains the Th17 (IL-17 already mapped) arm of the inflammatory dimension of the Carney-complex tumour microenvironment."
  - target: 01-human/04-cellular/t-cytotoxic-cell
    relation: connects-to
    note: "Cytotoxic surveillance: the cytotoxic T cells (perforin already mapped) provide the antitumour surveillance of the myxomas and endocrine tumours of the Carney complex."
  - target: 01-human/04-cellular/t-helper-cell
    relation: connects-to
    note: "CD4 helper source: the CD4 T-helper cells are the source of the Th1/Th2/Th17 (IFN-γ, IL-4 and IL-17 already mapped) cytokines shaping the immune microenvironment of the Carney-complex tumours."
  ...
  - target: 01-human/03-molecular/histamine
    relation: connects-to
    note: "Mast-cell myxoma axis: histamine, from mast cells (already mapped) in the cardiac myxoma and the skin tumour stroma, amplifies the angiogenesis (already mapped) and the immunosuppressive cytokine milieu of the Carney-complex tumours."
  - target: 01-human/03-molecular/melatonin
    relation: connects-to
    note: "Circadian-cAMP axis: melatonin, via MT1/MT2 receptors on PRKAR1A-deficient (already mapped) tumour cells, modulates the cAMP/PKA (already mapped) signalling and the circadian disruption of the neuroendocrine tumours of Carney complex."
  ...
  - target: 01-human/03-molecular/bdnf
    relation: connects-to
    note: "carney bdnf: BDNF from fibroblasts (already mapped) and macrophages (already mapped) modulates tumour neuroplasticity; bdnf excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and VEGF (already mapped) cascade in Carney complex."
  - target: 01-human/03-molecular/osteopontin
    relation: connects-to
    note: "carney osteopontin: osteopontin from fibroblasts (already mapped) and macrophages (already mapped) modulates tumour immune matrix; osteopontin excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and VEGF (already mapped) cascade in Carney complex."
...
- `connects-to` → **[Perforin](../../03-molecular/perforin/README.md)** — Perforin-mediated cytotoxic immunosurveillance is the immune clearance that the multiple neoplasms of Carney complex must evade.
- `connects-to` → **[S100A8/A9](../../03-molecular/s100a8-a9/README.md)** — S100A8/A9 alarmins shape the inflammatory stroma of the cardiac and cutaneous myxomas and tumors of Carney complex.
- `connects-to` → **[MDM2](../../03-molecular/mdm2/README.md)** — MDM2-mediated degradation of p53 restrains apoptosis in the PRKAR1A-driven tumors of Carney complex.
- `connects-to` → **[SRC Kinase](../../03-molecular/src-kinase/README.md)** — SRC-family kinase signaling contributes to the proliferative signaling of the endocrine and mesenchymal tumors of Carney complex.
- `connects-to` → **[DNMT3A](../../03-molecular/dnmt3a/README.md)** — DNMT3A-mediated DNA methylation contributes to the epigenetic regulation of the tumors of Carney complex.
- `connects-to` → **[Autophagy](../../03-molecular/autophagy/README.md)** — Autophagy modulates the survival of the PKA-dysregulated cells of Carney complex.
- `connects-to` → **[AMPK](../../03-molecular/ampk/README.md)** — AMPK-linked metabolic signaling interacts with the dysregulated PKA-cAMP signaling (PRKAR1A already mapped) of Carney complex.
- `connects-to` → **[CCR5](../../03-molecular/ccr5/README.md)** — CCR5-driven myeloid recruitment shapes the tumor microenvironment of the neoplasms of Carney complex.
- `connects-to` → **[ARID1A](../../03-molecular/arid1a/README.md)** — ARID1A-containing SWI/SNF chromatin remodeling participates in the epigenetic landscape of the tumors of Carney complex.
- `connects-to` → **[CXCL12](../../03-molecular/cxcl12/README.md)** — CXCL12-CXCR4 signaling participates in the tumor-stromal interactions of the neoplasms of Carney complex.
- `connects-to` → **[IL-1β](../../03-molecular/il-1b/README.md)** — IL-1β-driven inflammation participates in the tumor microenvironment of the neoplasms of Carney complex.
- `connects-to` → **[IL-33](../../03-molecular/il-33/README.md)** — IL-33 alarmin signaling participates in the tumor-immune microenvironment of Carney complex.
...
- `connects-to` → **[IL-12](../../03-molecular/il-12/README.md)** — Th1 polarisation: IL-12 polarises the Th1 (IFN-γ already mapped) arm of the immune microenvironment of the Carney-complex tumours.
- `connects-to` → **[IL-5](../../03-molecular/il-5/README.md)** — Type-2 arm: IL-5, with the type-2 cytokines (IL-4 and IL-13 already mapped), is the eosinophil/Th2 dimension of the immune microenvironment of the Carney-complex tumours.
- `connects-to` → **[IL-23](../../03-molecular/il-23/README.md)** — Th17 axis: IL-23 sustains the Th17 (IL-17 already mapped) arm of the inflammatory dimension of the Carney-complex tumour microenvironment.

...
cross_links:
  ...
  - target: 01-human/02-atomic/carbon
    relation: connects-to
    note: "HL carbon: carbon in nucleotides of macrophages (already mapped) and mast cells (already mapped) fuels Reed-Sternberg-cell proliferation; carbon dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) cascade in HL."
  - target: 01-human/02-atomic/hydrogen
    relation: connects-to
    note: "HL hydrogen: hydrogen via ROS from macrophages (already mapped) and mast cells (already mapped) modulates redox homeostasis; hydrogen excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) Reed-Sternberg cascade in HL."
  - target: 01-human/02-atomic/sulfur
    relation: connects-to
    note: "HL sulfur: sulfur-containing amino acids in macrophages (already mapped) and mast cells (already mapped) regulate redox signalling; sulfur dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) Reed-Sternberg cascade in HL."
  - target: 01-human/03-molecular/glp-1
    relation: connects-to
    note: "HL glp-1: GLP-1 from neurons (already mapped) and macrophages (already mapped) modulates metabolic-inflammatory tone; glp-1 dysfunction amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) Reed-Sternberg cascade in HL."
  - target: 01-human/03-molecular/angiotensin-ii
    relation: connects-to
    note: "HL angiotensin-ii: angiotensin-II from endothelial cells (already mapped) and macrophages (already mapped) drives vascular remodelling; angiotensin-ii excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) Reed-Sternberg cascade in HL."
  ...
  - target: 01-human/03-molecular/substance-p
    relation: connects-to
    note: "HL substance-p: substance-P from macrophages (already mapped) and Reed-Sternberg cells (already mapped) modulates lymphoma pain tone; substance-P excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) cascade in HL."
  - target: 01-human/03-molecular/insulin-receptor
    relation: connects-to
    note: "HL insulin-receptor: insulin receptor on macrophages (already mapped) and Reed-Sternberg cells (already mapped) modulates lymphoma metabolic axis; insulin-receptor loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) cascade in HL."
  - target: 01-human/03-molecular/aldosterone
    relation: connects-to
    note: "HL aldosterone: aldosterone from macrophages (already mapped) and Reed-Sternberg cells (already mapped) modulates lymphoma fluid balance; aldosterone excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) cascade in HL."
  - target: 01-human/03-molecular/androgen-receptor
    relation: connects-to
    note: "HL androgen-receptor: androgen receptor on macrophages (already mapped) and Reed-Sternberg cells (already mapped) modulates lymphoma androgen axis; androgen-receptor loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) cascade in HL."
  - target: 01-human/03-molecular/norepinephrine
    relation: connects-to
    note: "HL norepinephrine: norepinephrine from neurons (already mapped) and macrophages (already mapped) modulates lymphoma adrenergic tone; norepinephrine excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) Reed-Sternberg cascade in HL."
...
- `connects-to` → **[Carbon](../../02-atomic/carbon/README.md)** — HL carbon: carbon in nucleotides of macrophages (already mapped) and mast cells (already mapped) fuels Reed-Sternberg-cell proliferation; carbon dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) cascade in HL.
- `connects-to` → **[Hydrogen](../../02-atomic/hydrogen/README.md)** — HL hydrogen: hydrogen via ROS from macrophages (already mapped) and mast cells (already mapped) modulates redox homeostasis; hydrogen excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) Reed-Sternberg cascade in HL.
- `connects-to` → **[Sulfur](../../02-atomic/sulfur/README.md)** — HL sulfur: sulfur-containing amino acids in macrophages (already mapped) and mast cells (already mapped) regulate redox signalling; sulfur dysregulation amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) Reed-Sternberg cascade in HL.
...
- `connects-to` → **[Substance-P](../../03-molecular/substance-p/README.md)** — HL substance-p: substance-P from macrophages (already mapped) and Reed-Sternberg cells (already mapped) modulates lymphoma pain tone; substance-P excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) cascade in HL.
- `connects-to` → **[Insulin Receptor](../../03-molecular/insulin-receptor/README.md)** — HL insulin-receptor: insulin receptor on macrophages (already mapped) and Reed-Sternberg cells (already mapped) modulates lymphoma metabolic axis; insulin-receptor loss amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) cascade in HL.
- `connects-to` → **[Aldosterone](../../03-molecular/aldosterone/README.md)** — HL aldosterone: aldosterone from macrophages (already mapped) and Reed-Sternberg cells (already mapped) modulates lymphoma fluid balance; aldosterone excess amplifies NF-κB (already mapped) and IL-6 (already mapped) and T-cytotoxic (already mapped) cascade in HL.

...
cross_links:
  ...
  - target: 01-human/04-cellular/mast-cell
    relation: connects-to
    note: "Stromal mast cells: the mast cells of the tumour stroma contribute to the angiogenesis (VEGF already mapped) and the type-2 microenvironment of Wilms tumour."
  - target: 01-human/04-cellular/t-helper-cell
    relation: connects-to
    note: "CD4 helper source: the CD4 T-helper cells are the source of the Th1/Th2/Th17 (IFN-γ, IL-4 and IL-17 already mapped) cytokines shaping the immune microenvironment of Wilms tumour."
  ...
  - target: 01-human/03-molecular/tslp
    relation: connects-to
    note: "Stromal alarmin: TSLP released from the nephroblastoma stroma (fibroblast already mapped) activates mast cells (already mapped) and dendritic cells (already mapped), promoting the type-2 immunosuppressive microenvironment of the Wilms-tumour blastemal and stromal compartments."
  - target: 01-human/03-molecular/bradykinin
    relation: connects-to
    note: "Renal kinin axis: bradykinin, generated by kallikrein activation in the tumour-adjacent kidney (already mapped) tissue of Wilms tumour, modulates local vascular permeability and contributes to the hypertension (already mapped) complication of the tumour."
  - target: 01-human/03-molecular/periostin
    relation: connects-to
    note: "Embryonic ECM scaffold: periostin, a developmental ECM glycoprotein active in the fetal kidney stroma (kidney already mapped), is upregulated in the stromal component of Wilms tumour and contributes to the desmoplastic microenvironment and local invasion."
  - target: 01-human/03-molecular/c1-esterase-inhibitor
    relation: connects-to
    note: "Classical complement brake: C1-esterase inhibitor restrains the classical complement C1 and the contact system (C3/C5aR1/factor-H already mapped) activated in the Wilms-tumour microenvironment, modulating complement-dependent immune surveillance of the nephroblastoma."
  - target: 01-human/03-molecular/histamine
    relation: connects-to
    note: "Mast-cell nephroblastoma mediator: histamine released by mast cells (already mapped) in the Wilms-tumour stroma promotes vascular permeability and the pro-tumourigenic type-2 microenvironment that sustains the immune evasion of the nephroblastoma."
  ...
  - target: 01-human/03-molecular/oxytocin
    relation: connects-to
    note: "Wilms oxytocin: oxytocin receptor on nephroblastoma cells attenuates IGF-1 (already mapped) and mTOR (already mapped) proliferative signalling; oxytocin-driven cAMP/PKA activation opposes WNT/β-catenin (already mapped)-mediated WT1 transcriptional reprogramming in Wilms tumour."
  - target: 01-human/03-molecular/vasopressin
    relation: connects-to
    note: "Wilms vasopressin: vasopressin V1A/V2 receptors on nephroblastoma cells modulate cAMP/PKA signalling, intersecting IGF-1 (already mapped)/mTOR (already mapped) and VEGF (already mapped) proliferative axes in the renal blastema of Wilms tumour."
  ...
  - target: 01-human/03-molecular/fibronectin
    relation: connects-to
    note: "WT fibronectin: Fibronectin in renal epithelial cells (already mapped) and macrophages (already mapped) scaffolds tumour ECM; fibronectin excess amplifies IL-6 (already mapped) and VEGF (already mapped) and mTOR (already mapped) tumour-promoting cascade of Wilms tumour."
  - target: 01-human/03-molecular/activin-a
    relation: connects-to
    note: "WT activin-a: activin-A from renal epithelial cells (already mapped) and macrophages (already mapped) regulates tumour immune-fibrotic balance; activin-a excess amplifies IL-6 (already mapped) and VEGF (already mapped) and mTOR (already mapped) tumour cascade of Wilms tumour."
  ...
  - target: 01-human/03-molecular/aldosterone
    relation: connects-to
    note: "WT aldosterone: aldosterone from renal epithelial cells (already mapped) and macrophages (already mapped) modulates WT ion balance; aldosterone excess amplifies IL-6 (already mapped) and VEGF (already mapped) and mTOR (already mapped) tumour-promoting cascade of WT."
  - target: 01-human/03-molecular/androgen-receptor
    relation: connects-to
    note: "WT androgen-receptor: androgen receptor on epithelial cells (already mapped) and macrophages (already mapped) modulates WT hormonal growth; androgen-receptor loss amplifies IL-6 (already mapped) and VEGF (already mapped) and mTOR (already mapped) tumour-promoting cascade of WT."
  ...
  - target: 01-human/03-molecular/epinephrine
    relation: connects-to
    note: "WT epinephrine: epinephrine from renal epithelial cells (already mapped) and macrophages (already mapped) modulates WT adrenergic vascular tone; epinephrine excess amplifies IL-6 (already mapped) and VEGF (already mapped) and mTOR (already mapped) tumour-promoting cascade of WT."
  - target: 01-human/03-molecular/myostatin
    relation: connects-to
    note: "WT myostatin: myostatin from renal epithelial cells (already mapped) and macrophages (already mapped) modulates WT muscle-stromal signalling; myostatin excess amplifies IL-6 (already mapped) and VEGF (already mapped) and mTOR (already mapped) tumour-promoting cascade of WT."
  - target: 01-human/03-molecular/angiopoietin
    relation: connects-to
    note: "WT angiopoietin: angiopoietin from endothelial cells (already mapped) and macrophages (already mapped) regulates WT tumour vascular integrity; angiopoietin loss amplifies IL-6 (already mapped) and VEGF (already mapped) and mTOR (already mapped) tumour-promoting cascade of WT."
---
...
- `connects-to` → **[TSLP](../../03-molecular/tslp/README.md)** — Stromal alarmin: TSLP released from the nephroblastoma stroma (fibroblast already mapped) activates mast cells (already mapped) and dendritic cells (already mapped), promoting the type-2 immunosuppressive microenvironment of the Wilms-tumour blastemal and stromal compartments.
- `connects-to` → **[Bradykinin](../../03-molecular/bradykinin/README.md)** — Renal kinin axis: bradykinin, generated by kallikrein activation in the tumour-adjacent kidney (already mapped) tissue of Wilms tumour, modulates local vascular permeability and contributes to the hypertension (already mapped) complication of the tumour.
- `connects-to` → **[Periostin](../../03-molecular/periostin/README.md)** — Embryonic ECM scaffold: periostin, a developmental ECM glycoprotein active in the fetal kidney stroma (kidney already mapped), is upregulated in the stromal component of Wilms tumour and contributes to the desmoplastic microenvironment and local invasion.
...
- `connects-to` → **[Epinephrine](../../03-molecular/epinephrine/README.md)** — WT epinephrine: epinephrine from renal epithelial cells (already mapped) and macrophages (already mapped) modulates WT adrenergic vascular tone; epinephrine excess amplifies IL-6 (already mapped) and VEGF (already mapped) and mTOR (already mapped) tumour-promoting cascade of WT.
- `connects-to` → **[Myostatin](../../03-molecular/myostatin/README.md)** — WT myostatin: myostatin from renal epithelial cells (already mapped) and macrophages (already mapped) modulates WT muscle-stromal signalling; myostatin excess amplifies IL-6 (already mapped) and VEGF (already mapped) and mTOR (already mapped) tumour-promoting cascade of WT.
- `connects-to` → **[Angiopoietin](../../03-molecular/angiopoietin/README.md)** — WT angiopoietin: angiopoietin from endothelial cells (already mapped) and macrophages (already mapped) regulates WT tumour vascular integrity; angiopoietin loss amplifies IL-6 (already mapped) and VEGF (already mapped) and mTOR (already mapped) tumour-promoting cascade of WT.
